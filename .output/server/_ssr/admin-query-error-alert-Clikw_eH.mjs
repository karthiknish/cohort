...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-query-error-alert-Clikw_eH.js
var import_jsx_runtime = require_jsx_runtime();
/**
* Inline banner for Convex query/load failures on admin pages.
*/
function AdminQueryErrorAlert({ error, title = "Unable to load data" }) {
...
//#endregion
export { AdminQueryErrorAlert as t };
