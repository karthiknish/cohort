...
import { i as DialogDescription, r as DialogContent, s as DialogTitle, t as Dialog } from "./dialog-C8tBdgAy.mjs";
import { t as _e } from "../_libs/cmdk.mjs";
require_react();
var import_jsx_runtime = require_jsx_runtime();
var Command$1 = ({ className, ref, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(_e, {
	ref,
