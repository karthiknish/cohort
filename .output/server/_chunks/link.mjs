...
var Link = (0, import_react.forwardRef)(function Link({ href, children, onClick, onMouseEnter, onPointerDown, replace, target, prefetch = true, scroll: _scroll, passHref: _passHref, legacyBehavior: _legacy, shallow: _shallow, locale: _locale, transitionTypes: _transitionTypes, ...rest }, ref) {
