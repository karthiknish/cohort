...
import { i as m, n as useReducedMotion, o as LazyMotion, r as domAnimation, s as AnimatePresence } from "../_libs/framer-motion.mjs";
...
import { _ as formatEnUsCurrency, d as AGENT_CHART_WHOLE_NUMBER_FORMATTER, i as formatRelativeTime, t as cn } from "./utils.mjs";
import { C as motionEasing, S as motionDurationSeconds, _ as chromaticTransitionNormalClass } from "./motion.mjs";
...
import { a as notifySuccess, c as reportConvexFailure, n as notifyError, r as notifyFailure, s as convexErrorMessage } from "./notifications.mjs";
import { i as useRouter, r as usePathname } from "./navigation.mjs";
import { b as getPreviewAgentModeResponse, ct as isPreviewModeEnabled, i as useAuth, n as useClientContext } from "./client-context.mjs";
import { t as UnifiedError } from "./unified-error.mjs";
import { D as filesApi, I as projectsApi, Y as usersApi, m as agentApi, q as tasksApi } from "./convex-api.mjs";
import { n as useUrlSearchParamsContext } from "./use-url-search-params.mjs";
import { c as DropdownMenuSeparator, i as DropdownMenuItem, l as DropdownMenuTrigger, o as DropdownMenuRadioGroup, r as DropdownMenuContent, s as DropdownMenuRadioItem, t as DropdownMenu } from "./dropdown-menu.mjs";
import { t as Input } from "./input.mjs";
import { n as FadeInItem, r as FadeInStagger } from "./animate-in.mjs";
import { i as TooltipTrigger, n as TooltipContent, r as TooltipProvider, t as Tooltip } from "./tooltip.mjs";
import { o as getChartColor } from "./colors.mjs";
...
import { r as SheetContent, t as Sheet } from "./sheet.mjs";
import { O as uploadStorageFileWithPublicUrl, a as AttachmentKindIcon, i as ChatTypingIndicator, o as ChatMediaGallery, r as Textarea, s as getAttachmentKind, t as VoiceInputButton } from "./voice-input.mjs";
import { t as ScrollArea } from "./scroll-area.mjs";
import { o as workbookToXlsxBlob, r as ensureXlsxFilename, t as buildCohortsSpreadsheetWorkbook } from "./cohorts-spreadsheet.mjs";
import { a as agentAttachmentsToChatMedia, c as getPdfUploadSizeError, d as parseAgentAttachmentsFromStored, f as readFileAsBase64, h as useClientNow, i as AGENT_ATTACHMENT_ACCEPT, l as hasUsableAttachmentContext, m as toAgentRequestAttachmentContext, n as AgentMentionText, o as buildAgentAttachmentContext, p as serializeAgentAttachmentsForStorage, r as splitAgentTextWithMentions, s as createPendingAttachmentPlaceholder, t as AgentMentionPills, u as hydrateAgentAttachmentUrls, y as useNavigationContext } from "./mention-highlights.mjs";
import { d as normalizeAuthRole, n as useKeyboardShortcut, s as can } from "./use-keyboard-shortcuts.mjs";
//#region src/shared/components/agent-mode/agent-mode-button.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-message-constants.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-message-utils.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-attachments.tsx
...
//#endregion
//#region src/lib/agent-errors.ts
...
//#endregion
//#region src/shared/components/agent-mode/mention-dropdown.tsx
var EMPTY_CLIENTS = [];
var EMPTY_PROJECTS = [];
var EMPTY_TEAMS = [];
var EMPTY_USERS = [];
...
function MentionDropdown({ ref, listboxId = "agent-mention-listbox", isOpen, onClose, onSelect, searchQuery, clients = EMPTY_CLIENTS, projects = EMPTY_PROJECTS, teams = EMPTY_TEAMS, users = EMPTY_USERS, isLoading = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LazyMotion, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(m.div, {
			ref: dropdownRef,
			id: listboxId,
			role: "listbox",
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-composer.tsx
function ConnectionIndicator({ status }) {
	if (status === "connected") return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(m.output, {
		"aria-live": "polite",
...
function RateLimitBanner({ countdown, onDismiss }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(m.output, {
		"aria-live": "assertive",
		initial: MOTION_FADE_SLIDE_UP,
		animate: MOTION_VISIBLE,
		exit: MOTION_FADE_SLIDE_UP_EXIT,
...
//#endregion
//#region src/lib/agent-panel-layout.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-header.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: connectionStatus !== "connected" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConnectionIndicator, { status: connectionStatus }) : null }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					variant: "ghost",
					size: "icon",
...
//#endregion
//#region src/shared/components/agent-mode/agent-conversation-item.tsx
...
//#endregion
//#region src/lib/agent-history.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-history-rail.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-execution-timeline.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-message-data/helpers.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-message-data/charts.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-message-data/sections.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-message-data/chart-fill.ts
function getAgentChartFill(index) {
	return getChartColor(index);
}
//#endregion
//#region src/shared/components/agent-mode/agent-message-visualizations.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: series.points.map((point, index) => {
				...
				if (point.href) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					href: point.href,
...
function AgentListSection({ section, accentClass }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		...
		children: section.items.map((item) => {
			...
			if (item.href) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				href: item.href,
...
//#endregion
//#region src/shared/components/agent-mode/agent-data-sections.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-plain-text.tsx
...
//#endregion
//#region src/lib/agent/spreadsheet-export.ts
...
//#endregion
//#region src/shared/components/agent-mode/agent-spreadsheet-download.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-message-card.tsx
...
function AgentMessageCard({ message, mentionLabels = EMPTY_MENTION_LABELS, conversationId = null, workspaceId = null, onStoreSpreadsheetExport, onRetryLastUserTurn, onRetryUserMessage, onConfirmPending, onUndoAction, isProcessing }) {
	...
	if (type === "user") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LazyMotion, {
		features: domAnimation,
...
//#endregion
//#region src/shared/components/agent-mode/agent-messages-section.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: isConversationLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				}), isProcessing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(m.div, {
...
//#endregion
//#region src/shared/components/agent-mode/agent-failed-message-banner.tsx
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-shell.tsx
function AgentModePanelShell({ isOpen, onOpenChange, panelLayout = "docked", attachmentAccept, children, contextBanner, fileInputRef, headerProps, historyPanelProps, agentError, lastFailedMessage, onClearError, onDragLeave, onDragOver, onDrop, onFileSelection, rateLimitCountdown, composerInputRef, onRequestClose }) {
	...
	const shellBody = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: typeof rateLimitCountdown === "number" && rateLimitCountdown > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RateLimitBanner, {
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel-content.tsx
...
//#endregion
//#region src/shared/hooks/use-mention-data.ts
...
//#endregion
//#region src/lib/agent-suggestions.ts
...
function trackAgentSuggestionClick(options) {
	if (typeof window === "undefined") return;
	import("./analytics.mjs").then((n) => n.t).then(({ logAnalyticsEvent }) => {
...
//#endregion
//#region src/lib/agent-close-guard.ts
...
//#endregion
//#region src/lib/agent-panel-url.ts
...
//#endregion
//#region src/shared/hooks/use-agent-panel-url.ts
...
//#endregion
//#region src/lib/agent-mentions.ts
...
//#endregion
//#region src/shared/components/agent-mode/use-agent-panel-composer.ts
...
//#endregion
//#region src/shared/components/agent-mode/use-agent-mode-panel.ts
var noop = () => {};
...
//#endregion
//#region src/shared/components/agent-mode/agent-mode-panel.tsx
...
//#endregion
//#region src/lib/agent-message-lifecycle.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/use-agent-attachments.ts
...
//#endregion
//#region src/lib/agent-conversation-export.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/stored-message-utils.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/map-stored-messages.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/use-agent-conversation-history.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/agent-send-response.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/use-agent-task-undo.ts
...
//#endregion
//#region src/shared/hooks/agent-mode/use-agent-send.ts
var DEBOUNCE_MS = 300;
...
//#endregion
//#region src/shared/hooks/agent-mode/use-agent-mode.ts
...
//#endregion
//#region src/shared/components/agent-mode/index.tsx
/**
