...
import { t as Drawer$1 } from "../_libs/vaul.mjs";
import { t as cn } from "./utils.mjs";
import { E as surfaceMotionClasses } from "./motion.mjs";
//#region src/shared/hooks/use-is-mobile.ts
...
//#endregion
//#region src/shared/ui/drawer.tsx
var import_jsx_runtime = require_jsx_runtime();
function Drawer({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1.Root, {
		"data-slot": "drawer",
		...props
	});
}
function DrawerTrigger({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1.Trigger, {
		"data-slot": "drawer-trigger",
		...props
	});
}
function DrawerPortal({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1.Portal, {
		"data-slot": "drawer-portal",
		...props
	});
}
function DrawerClose({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1.Close, {
		"data-slot": "drawer-close",
		...props
	});
}
function DrawerOverlay({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1.Overlay, {
...
function DrawerContent({ className, children, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DrawerPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawerOverlay, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Drawer$1.Content, {
...
//#endregion
export { useIsMobile as a, DrawerTrigger as i, DrawerClose as n, DrawerContent as r, Drawer as t };
