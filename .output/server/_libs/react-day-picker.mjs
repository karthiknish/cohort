...
import { B as differenceInCalendarDays, C as eachYearOfInterval, D as eachMonthOfInterval, E as startOfMonth, F as isSameDay, G as addDays, H as startOfISOWeek, I as min, L as max, M as differenceInCalendarMonths, O as endOfMonth, P as isDate, R as addYears, S as endOfWeek, T as endOfYear, U as startOfWeek, V as startOfDay, W as addMonths, _ as format, b as enUS$1, c as isSameYear, d as isAfter, f as getYear, l as isSameMonth, n as setMonth, p as getMonth, t as setYear, u as isBefore, v as getWeek, w as startOfYear, x as endOfISOWeek, y as getISOWeek, z as addWeeks } from "./date-fns.mjs";
...
function useRange(props, dateLib) {
	...
	const select = (triggerDate, modifiers, e) => {
		const { min, max } = props;
		const newRange = triggerDate ? addToRange(triggerDate, selected, min, max, required, dateLib) : void 0;
