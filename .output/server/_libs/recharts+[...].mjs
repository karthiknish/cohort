...
var _excluded$21 = ["children"], _excluded2$8 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
	...
	if (!(0, import_isNil.default)(nextChild) && !(0, import_isNil.default)(prevChild)) {
		...
		var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$21(_ref2, _excluded2$8);
...
var _excluded$13 = ["valueAccessor"], _excluded2$6 = [
	"data",
	"dataKey",
	"clockWise",
	"id",
...
function LabelList(_ref) {
	...
	var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$13(restProps, _excluded2$6);
...
var Radar = /*#__PURE__*/ function(_PureComponent) {
	function Radar() {
		...
		_defineProperty$18(_this, "handleMouseEnter", function(e) {
			var onMouseEnter = _this.props.onMouseEnter;
			if (onMouseEnter) onMouseEnter(_this.props, e);
		});
		_defineProperty$18(_this, "handleMouseLeave", function(e) {
	...
	return _createClass$13(Radar, [
		...
		},
		{
			...
			value: function renderPolygonStatically(points) {
				...
				else radar = /*#__PURE__*/ import_react.createElement(Polygon, _extends$13({}, filterProps(this.props, true), {
		...
		value: function renderDotItem(option, props) {
			...
			if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
				...
				dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$13({}, dotProps, {
					key,
...
_defineProperty$18(Radar, "displayName", "Radar");
_defineProperty$18(Radar, "defaultProps", {
	angleAxisId: 0,
	radiusAxisId: 0,
	hide: false,
	activeDot: true,
...
_defineProperty$18(Radar, "getComposedData", function(_ref2) {
...
//#endregion
export { XAxis as a, CartesianGrid as c, PolarAngleAxis as d, PolarRadiusAxis as f, Legend as g, Tooltip as h, YAxis as i, Bar as l, ResponsiveContainer as m, RadarChart as n, Area as o, PolarGrid as p, BarChart as r, Line as s, AreaChart as t, Radar as u };
