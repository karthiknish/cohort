...
function fe(e, o, t, i) {
	...
	const n = d || t.getBoundingClientRect(), f = i.getBoundingClientRect();
	d = {
		x: O(e, n.x, f.x - n.x, o),
		y: O(e, n.y, f.y - n.y, o),
		width: O(e, n.width, f.width - n.width, o),
		height: O(e, n.height, f.height - n.height, o)
...
function Pe(e) {
	...
	const i = l("__activeElement"), d = (r = l("popover")) == null ? void 0 : r.wrapper, n = U([...d ? [d] : [], ...i ? [i] : []]), f = n[0], w = n[n.length - 1];
	if (e.preventDefault(), e.shiftKey) (n[n.indexOf(document.activeElement) - 1] || w)?.focus();
	else (n[n.indexOf(document.activeElement) + 1] || f)?.focus();
}
function ne(e) {
	var t;
...
function re(e, o, t) {
	const i = (n, f) => {
		const w = n.target;
		e.contains(w) && ((!t || t(w)) && (n.preventDefault(), n.stopPropagation(), n.stopImmediatePropagation()), f?.(n));
	};
	document.addEventListener("pointerdown", i, !0), document.addEventListener("mousedown", i, !0), document.addEventListener("pointerup", i, !0), document.addEventListener("mouseup", i, !0), document.addEventListener("click", (n) => {
		i(n, o);
	}, !0);
}
function ke() {
...
function Q(e, o) {
	...
	u.className = `driver-popover ${((b = o.popover) == null ? void 0 : b.popoverClass) || s("popoverClass") || ""}`.trim(), re(t.wrapper, (E) => {
		var B, R, W;
	...
	const S = U([u, ...e.classList.contains("driver-dummy-element") ? [] : [e]]);
...
function ae(e, o) {
	...
	if (f === "top" && a ? x = h = c = !1 : f === "bottom" && c ? x = h = a = !1 : f === "left" && h ? x = a = c = !1 : f === "right" && x && (h = a = c = !1), f === "over") {
		...
		const b = Math.min(u, window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width), P = Z(n, {
			elementDimensions: g,
			popoverDimensions: r,
			popoverPadding: w,
		...
		const b = Math.min(m, window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width), P = Z(n, {
			elementDimensions: g,
			popoverDimensions: r,
			popoverPadding: w,
			popoverArrowDimensions: v
...
function Ee(e, o, t) {
	...
	let u = o, h = e;
	if (o === "top" ? (g + v <= 0 ? (u = "right", h = "end") : g + v - w <= 0 && (u = "top", h = "start"), g >= r ? (u = "left", h = "end") : g + w >= r && (u = "top", h = "end")) : o === "bottom" ? (g + v <= 0 ? (u = "right", h = "start") : g + v - w <= 0 && (u = "bottom", h = "start"), g >= r ? (u = "left", h = "start") : g + w >= r && (u = "bottom", h = "end")) : o === "left" ? (p + c <= 0 ? (u = "bottom", h = "end") : p + c - y <= 0 && (u = "left", h = "start"), p >= a ? (u = "top", h = "end") : p + y >= a && (u = "left", h = "end")) : o === "right" && (p + c <= 0 ? (u = "bottom", h = "start") : p + c - y <= 0 && (u = "right", h = "start"), p >= a ? (u = "top", h = "start") : p + y >= a && (u = "right", h = "end")), !u) f.classList.add("driver-popover-arrow-none");
	else {
...
function Ae(e = {}) {
	...
	function g(a = !0) {
		...
		if (a && h) {
			h(!p || (p == null ? void 0 : p.id) === "driver-dummy-element" ? void 0 : p, c, {
				config: s(),
				state: l(),
				driver: _()
			});
