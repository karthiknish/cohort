...
import { Video, RefreshCw, Copy } from 'lucide-react';
import { Button } from '@/shared/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/shared/ui/card';
import { Badge } from '@/shared/ui/badge';
export default function MeetingsError({ error, unstable_retry, reset, }: {
    error: Error & {
        digest?: string;
    };
    unstable_retry?: () => void;
    ...
    return (<div className="flex min-h-[60vh] items-center justify-center p-4">
      <Card className="max-w-md border-muted/60">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isDev
            ? 'The meetings panel encountered an unexpected error. Check the console for details.'
            : 'Something went wrong loading meetings. The rest of the dashboard is unaffected.'}
          </CardDescription>
        </CardHeader>
