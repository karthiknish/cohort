...
export default function ProposalsError({ error, unstable_retry, reset, }: {
    error: Error & {
        digest?: string;
    };
    unstable_retry?: () => void;
    ...
    return (<div className="flex min-h-[60vh] items-center justify-center p-4">
      <Card className="max-w-md border-muted/60">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isDev
            ? 'The proposals panel encountered an unexpected error. Check the console for details.'
            : 'Something went wrong loading proposals. The rest of the dashboard is unaffected.'}
          </CardDescription>
        </CardHeader>
