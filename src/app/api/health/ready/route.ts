...
/** Detailed readiness — admin session or `Authorization: Bearer $HEALTH_CHECK_SECRET`. */
export const GET = createApiHandler({
    ...
    const payload = overallStatus === 'healthy'
        ? apiSuccess(response)
        : {
            ...apiError(overallStatus === 'degraded' ? 'Service health degraded' : 'Service unavailable', 'SERVICE_UNAVAILABLE'),
            data: response,
        };
