...
export default function AuthPage() {
  ...
  const handleSubmit = (type: 'signin' | 'signup') => async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: getErrorMessage(err, 'Authentication failed. Please try again.'),
        variant: 'destructive',
      })
    }
  }
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: getErrorMessage(err, 'Google sign-in failed. Please try again.'),
        variant: 'destructive',
      })
    }
  }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/50 py-12 px-4">
      <FadeIn as="div" className="w-full max-w-lg">
