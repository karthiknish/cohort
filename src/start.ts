...
function applySecurityHeaders(response: Response): Response {
  // Response.redirect() and some framework responses have immutable headers.
  // Clone into a mutable response when needed.
  ...
  const forwardedProto = mutable.headers.get('x-forwarded-proto')
  if (mutable.url?.startsWith('https://') || forwardedProto === 'https') {
    mutable.headers.set(
