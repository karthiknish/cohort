...
type ConvexRequestArgs = Record<string, unknown> & {
    workspaceId?: string;
};
 ...
 */
export async function trackProposalEvent(input: WorkspaceScopedInput): Promise<{
    id: string;
}> {
 ...
 */
export async function trackDraftCreated(workspaceId: string, proposalId: string, clientId?: string | null, clientName?: string | null): Promise<void> {
 ...
 */
export async function trackAiGenerationStarted(workspaceId: string, proposalId: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackAiGenerationCompleted(workspaceId: string, proposalId: string, duration: number, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackAiGenerationFailed(workspaceId: string, proposalId: string, error: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackDeckGenerationStarted(workspaceId: string, proposalId: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackDeckGenerationCompleted(workspaceId: string, proposalId: string, duration: number, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackDeckGenerationFailed(workspaceId: string, proposalId: string, error: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackProposalSubmitted(workspaceId: string, proposalId: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function trackProposalSent(workspaceId: string, proposalId: string, clientId?: string | null, clientName?: string | null): Promise<void> {
    await trackProposalEvent({
        workspaceId,
 ...
 */
export async function fetchProposalAnalyticsSummary(workspaceId: string, filters?: ProposalAnalyticsFilters): Promise<ProposalAnalyticsSummary> {
 ...
 */
export async function fetchProposalAnalyticsTimeSeries(workspaceId: string, filters?: ProposalAnalyticsFilters): Promise<ProposalAnalyticsTimeSeriesPoint[]> {
    const res = (await queryConvex('proposalAnalytics:timeSeries', {
        ...
        timeseries: ProposalAnalyticsTimeSeriesPoint[];
    };
 ...
 */
export async function fetchProposalAnalyticsByClient(workspaceId: string, filters?: ProposalAnalyticsFilters): Promise<ProposalAnalyticsByClient[]> {
 ...
 */
export async function fetchProposalAnalyticsEvents(workspaceId: string, filters?: ProposalAnalyticsFilters & {
    limit?: number;
