...
// =============================================================================
import type { PlatformInsight, PlatformInsightResult, LinkedInAdsCalculatedMetrics, } from '../shared/insights-types';
/**
...
export function calculateLinkedInAdsMetrics(metrics: LinkedInAdsRawMetrics): LinkedInAdsCalculatedMetrics {
    ...
    // Total Engagements
    const totalEngagements = metrics.totalEngagements ?? ((metrics.reactions ?? 0) +
        (metrics.comments ?? 0) +
        (metrics.shares ?? 0) +
        clicks +
        (metrics.follows ?? 0));
 ...
 */
export function generateLinkedInAdsInsights(metrics: LinkedInAdsRawMetrics, calculated: LinkedInAdsCalculatedMetrics): PlatformInsight[] {
