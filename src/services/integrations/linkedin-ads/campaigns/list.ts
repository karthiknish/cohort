...
import type { LinkedInCampaign, LinkedInCampaignGroup, LinkedInAd, } from '../types';
// =============================================================================
// LIST CAMPAIGNS
// =============================================================================
export async function listLinkedInCampaigns(options: {
    ...
    const { accessToken, accountId, statusFilter = ['ACTIVE', 'PAUSED'], maxRetries = 3, } = options;
...
export async function fetchLinkedInAds(options: {
    ...
    const { accessToken, accountId, campaignId, statusFilter = ['ACTIVE', 'PAUSED'], maxRetries = 3, } = options;
    const params = new URLSearchParams({
        q: 'search',
        'search.account.values[0]': `urn:li:sponsoredAccount:${accountId}`,
        count: '100',
