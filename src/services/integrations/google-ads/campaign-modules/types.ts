...
// =============================================================================
export type GoogleCampaignObjective = 'SALES' | 'LEADS' | 'WEBSITE_TRAFFIC' | 'PRODUCT_AND_BRAND_CONSIDERATION' | 'BRAND_AWARENESS_AND_REACH' | 'APP_PROMOTION' | 'LOCAL_STORE_VISITS_AND_PROMOTIONS';
