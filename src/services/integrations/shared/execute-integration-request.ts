...
export async function executeIntegrationRequest<T>(client: IntegrationApiClient, options: BaseRequestOptions, config?: {
    defaultMethod?: BaseRequestOptions['method'];
