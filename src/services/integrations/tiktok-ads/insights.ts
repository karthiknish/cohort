...
// =============================================================================
import type { PlatformInsight, PlatformInsightResult, TikTokAdsCalculatedMetrics, } from '../shared/insights-types';
/**
 ...
 */
export function generateTikTokAdsInsights(metrics: TikTokAdsRawMetrics, calculated: TikTokAdsCalculatedMetrics): PlatformInsight[] {
