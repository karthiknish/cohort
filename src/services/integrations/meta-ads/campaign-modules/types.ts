...
// =============================================================================
import type { AdvantageState, MutableAdvantageState, PlacementSoftOptOut, } from '../types';
// =============================================================================
// CAMPAIGN OBJECTIVES (Meta Marketing API v24.0)
// =============================================================================
export type CampaignObjective = 'OUTCOME_SALES' | 'OUTCOME_LEADS' | 'OUTCOME_TRAFFIC' | 'OUTCOME_ENGAGEMENT' | 'OUTCOME_AWARENESS' | 'OUTCOME_APP_PROMOTION' | 'OUTCOME_PAGE_LIKES' | 'SALES' | 'LEADS' | 'TRAFFIC' | 'ENGAGEMENT' | 'AWARENESS' | 'APP_PROMOTION' | 'PAGE_LIKES' | 'LINK_CLICKS' | 'CONVERSIONS' | 'STORE_TRAFFIC' | 'MESSAGES' | 'LEAD_GENERATION' | 'APP_INSTALLS' | 'VIDEO_VIEWS' | 'REACH' | 'BRAND_AWARENESS' | 'POST_ENGAGEMENT' | 'PAGE_ENGAGEMENT' | 'EVENT_RESPONSES' | 'OFFER_CLAIMS' | 'PRODUCT_CATALOG_SALES';
