...
export function extractLeadGenFormId(ad?: {
    leadgen_form_id?: string;
} | null, creative?: (LeadGenStorySpec & {
    leadgen_form_id?: string;
}) | null): string | undefined {
    if (ad?.leadgen_form_id)
    ...
    return (spec?.link_data?.call_to_action?.value?.leadgen_form_id
        || fromChild
...
export function isLeadGenAd(creative?: LeadGenStorySpec | null, ad?: {
    leadgen_form_id?: string;
} | null): boolean {
