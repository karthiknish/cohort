...
// =============================================================================
import { LEADS_OBJECTIVE_CONFIG, type LeadGenAdSetRequirements, type LeadGenCreativeRequirements, isLeadGenAd, extractLeadGenFormId, } from './leads';
import { SALES_OBJECTIVE_CONFIG, type SalesAdSetRequirements, SALES_CONVERSION_EVENTS, getConversionEventLabel, } from './sales';
import { TRAFFIC_OBJECTIVE_CONFIG, type TrafficAdSetRequirements, TRAFFIC_DESTINATIONS, } from './traffic';
import { ENGAGEMENT_OBJECTIVE_CONFIG, type EngagementAdSetRequirements, ENGAGEMENT_TYPES, } from './engagement';
import { AWARENESS_OBJECTIVE_CONFIG, type AwarenessAdSetRequirements, type ReachFrequencyConfig, } from './awareness';
import { APP_PROMOTION_OBJECTIVE_CONFIG, type AppPromotionAdSetRequirements, APP_EVENT_TYPES, APP_STORES, } from './app-promotion';
// Re-export all
export { LEADS_OBJECTIVE_CONFIG, type LeadGenAdSetRequirements, type LeadGenCreativeRequirements, isLeadGenAd, extractLeadGenFormId, };
export { SALES_OBJECTIVE_CONFIG, type SalesAdSetRequirements, SALES_CONVERSION_EVENTS, getConversionEventLabel, };
export { TRAFFIC_OBJECTIVE_CONFIG, type TrafficAdSetRequirements, TRAFFIC_DESTINATIONS, };
export { ENGAGEMENT_OBJECTIVE_CONFIG, type EngagementAdSetRequirements, ENGAGEMENT_TYPES, };
export { AWARENESS_OBJECTIVE_CONFIG, type AwarenessAdSetRequirements, type ReachFrequencyConfig, };
export { APP_PROMOTION_OBJECTIVE_CONFIG, type AppPromotionAdSetRequirements, APP_EVENT_TYPES, APP_STORES, };
...
export function getObjectiveConfig(objective: string) {
    ...
    if (mappedKey)
        return CAMPAIGN_OBJECTIVE_CONFIGS[mappedKey];
    return null;
}
