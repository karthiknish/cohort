...
export function normalizeMetaCallToActionType(
...
export function formatMetaCallToActionLabel(
  raw: string | undefined | null,
): string | undefined {
...
export function resolveMetaCallToActionType(
  callToAction?: { type?: string; name?: string } | null,
  fallbackType?: string,
): string | undefined {
