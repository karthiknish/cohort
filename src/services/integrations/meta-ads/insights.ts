...
// =============================================================================
import type { PlatformInsight, PlatformInsightResult, MetaAdsCalculatedMetrics, } from '../shared/insights-types';
/**
 ...
 */
export function generateMetaAdsInsights(metrics: MetaAdsRawMetrics, calculated: MetaAdsCalculatedMetrics): PlatformInsight[] {
