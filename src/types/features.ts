...
export const FEATURE_PRIORITY_COLORS: Record<FeaturePriority, string> = {
  low: 'border-slate-300 text-slate-600 dark:border-slate-600 dark:text-slate-400',
  medium: 'border-amber-300 text-amber-600 dark:border-amber-600 dark:text-amber-400',
  high: 'border-red-300 text-red-600 dark:border-red-600 dark:text-red-400',
}
