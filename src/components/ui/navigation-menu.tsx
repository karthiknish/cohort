...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      ...
      <ChevronDownIcon
        className={cn(
          "relative top-[1px] ml-1 size-3 group-data-[state=open]:rotate-180",
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "group-data-[viewport=false]/navigation-menu:duration-[var(--motion-duration-fast)] group-data-[viewport=false]/navigation-menu:ease-[var(--motion-ease-out)] group-data-[viewport=false]/navigation-menu:motion-reduce:animate-none",
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          surfaceMotionClasses.navigationViewport,
          className
        )}
        {...props}
      />
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        ...
        surfaceMotionClasses.navigationIndicator,
        className
      )}
      {...props}
    >
