 ...
 */
export function useGeocodeSearch(query: string, options?: {
    debounceMs?: number;
    enabled?: boolean;
}) {
 ...
 */
export function useGeocodeResolve(name: string, options?: {
    enabled?: boolean;
}) {
 ...
 */
export function useGeocodeResolveBatch(names: string[], options?: {
    enabled?: boolean;
}) {
    const { enabled = true } = options ?? {};
    return useQuery({
