...
export function AgentModePanelContent({ dockComposerProps, emptyComposerProps, viewState, lastFailedMessage, mentionLabels, messages, onRetry, onRetryLastUserTurn, onRetryUserMessage, onConfirmPending, onUndoAction, processingSteps, processingLabel, scrollAreaRef, onMessagesScroll, onJumpToLatest, conversationId, workspaceId, onStoreSpreadsheetExport, }: {
    ...
    return (<>
      <AgentMessagesSection isConversationLoading={isConversationLoading} isProcessing={isProcessing} mentionLabels={mentionLabels} messages={messages} onRetryLastUserTurn={onRetryLastUserTurn} onRetryUserMessage={onRetryUserMessage} onConfirmPending={onConfirmPending} onUndoAction={onUndoAction} processingSteps={processingSteps} processingLabel={processingLabel} scrollAreaRef={scrollAreaRef} onMessagesScroll={onMessagesScroll} showJumpToLatest={showJumpToLatest} onJumpToLatest={onJumpToLatest} workspaceId={workspaceId} conversationId={conversationId} onStoreSpreadsheetExport={onStoreSpreadsheetExport}/>
