...
export function PptViewerLoading({ className }: { className?: string }) {
  return (
    <div
      className={cn(
...
export function PptViewerThumbnailButton({
  slide,
  index,
  currentSlide,
  onGoToSlide,
...
export function PptViewerCanvas({
  title,
  slides,
  currentSlide,
  isFullscreen,
