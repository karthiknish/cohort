...
export function NavigationProvider({ children }: {
    ...
    const loadNavigationState = useCallback(() => {
        ...
        try {
            cleanupOldData();
            const projectId = localStorage.getItem(getClientStorageKey(STORAGE_KEYS.PROJECT_ID, selectedClientId));
            const projectName = localStorage.getItem(getClientStorageKey(STORAGE_KEYS.PROJECT_NAME, selectedClientId));
            const lastViewedTask = localStorage.getItem(getClientStorageKey(STORAGE_KEYS.LAST_VIEWED_TASK, selectedClientId));
            const lastViewedChannel = localStorage.getItem(getClientStorageKey(STORAGE_KEYS.LAST_VIEWED_CHANNEL, selectedClientId));
            setNavigationState({
                projectId,
                projectName,
                lastViewedTask,
