...
export type ChatMediaGalleryProps = {
    ...
    compact?: boolean;
    /** Flat mode removes card chrome for use in surfaces like the channel info dialog */
    flat?: boolean;
    className?: string;
};
...
function AttachmentName({ name, highlightTerms }: { name: string; highlightTerms?: string[] }) {
    return (
...
function MediaTile({
            ...
            <div className={cn('space-y-2', compact && 'max-w-md')}>
                <div className="flex items-center justify-between gap-2 py-2 text-sm">
                    <div className="flex min-w-0 items-center gap-2 text-sm">
                        ...
                        >
                            <AttachmentKindIcon kind="video" className={flat ? 'size-4' : 'size-5'} />
                        </span>
                ...
                <video
                    ...
                    className="max-h-72 w-full rounded-lg bg-foreground"
                    preload="metadata"
                >
    ...
    if (kind === 'pdf') {
        return (
            ...
            >
                ...
                >
                    <AttachmentKindIcon kind="pdf" className={flat ? 'size-4' : 'size-5'} />
                </span>
    ...
    return (
        ...
        >
            ...
            >
                <AttachmentKindIcon kind={kind} className={flat ? 'size-4' : 'size-5'} />
            </span>
            <div className="min-w-0 flex-1">
                <AttachmentName name={attachment.name} highlightTerms={highlightTerms} />
                ...
                <div
                    ...
                    className={cn(
                        ...
                        flat
                            ...
                            : 'rounded-2xl border border-dashed border-border/70 bg-muted/15 p-3',
                    )}
                >
                    <span
                        className={cn(
                            'flex size-10 shrink-0 items-center justify-center rounded-lg',
                            flat ? 'bg-muted/50 ring-0' : 'bg-muted/50 ring-1 ring-border/50',
                        )}
                    >
