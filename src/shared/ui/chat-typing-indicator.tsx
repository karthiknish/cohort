...
function TypingDots({ className }: { className?: string }) {
  return (
    <span className={cn('inline-flex items-center gap-1', className)} aria-hidden>
      <span
        key="typing-dot-0"
        className="size-1.5 rounded-full bg-primary animate-subtle-dot-drift [animation-delay:0ms]"
      />
      <span
        key="typing-dot-150"
        className="size-1.5 rounded-full bg-primary animate-subtle-dot-drift [animation-delay:150ms]"
      />
      <span
        key="typing-dot-300"
        className="size-1.5 rounded-full bg-primary animate-subtle-dot-drift [animation-delay:300ms]"
      />
    </span>
  )
}
