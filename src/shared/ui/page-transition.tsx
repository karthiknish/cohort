...
export function DirectionalPageTransition({ children }: TransitionProps) {
    return (<ViewTransition enter={DIRECTIONAL_TRANSITIONS} exit={DIRECTIONAL_TRANSITIONS} default="none">
      {children}
    </ViewTransition>);
}
export function RevealTransition({ children }: TransitionProps) {
    return (<ViewTransition enter="slide-up" default="none">
      {children}
    </ViewTransition>);
}
...
export function ShellRouteTransition({ children }: TransitionProps) {
    ...
    return (<ViewTransition enter="slide-up" exit="fade-out" default="none">
