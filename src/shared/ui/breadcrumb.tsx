...
import { linkMotionClass } from "@/lib/motion";
...
function BreadcrumbLink({ asChild, className, ...props }: React.ComponentProps<"a"> & {
    ...
    return (<Comp data-slot="breadcrumb-link" className={cn("hover:text-foreground", linkMotionClass, className)} {...props}/>);
}
function BreadcrumbPage({ className, ...props }: React.ComponentProps<"span">) {
    return (<span data-slot="breadcrumb-page" aria-disabled="true" aria-current="page" className={cn("text-foreground font-normal", className)} {...props}/>);
}
