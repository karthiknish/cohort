...
type CalendarRootProps = React.HTMLAttributes<HTMLDivElement> & { rootRef?: React.Ref<HTMLDivElement> }
type CalendarChevronProps = {
  className?: string
  orientation?: 'left' | 'right' | 'up' | 'down'
  [key: string]: unknown
}
type CalendarWeekNumberProps = React.ThHTMLAttributes<HTMLTableCellElement> & { week?: unknown }
