...
const hoverPrimaryBg = 'hover:bg-[color-mix(in_srgb,var(--primary)_88%,#0f172a_12%)]';
const hoverSecondaryBg = 'hover:bg-[color-mix(in_srgb,var(--secondary)_88%,#0f172a_12%)]';
const hoverDestructiveBg = 'hover:bg-[color-mix(in_srgb,var(--destructive)_88%,#0f172a_12%)]';
export const buttonVariants = cva([
    ...
    variants: {
        variant: {
            ...
            destructive: cn('bg-destructive text-destructive-foreground focus-visible:ring-destructive/20 shadow-sm', hoverDestructiveBg),
            ...
            secondary: cn('bg-secondary text-secondary-foreground shadow-sm', hoverSecondaryBg),
