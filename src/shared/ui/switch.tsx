...
const Switch = ({ className, ref, ...props }: SwitchProps) => (<SwitchPrimitives.Root className={cn("focus-ring-subtle peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent shadow-sm disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=unchecked]:bg-input", switchMotionClass, className)} {...props} ref={ref}>
