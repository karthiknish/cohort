...
export function DataTableHeaderCell<TData, TValue>({ header }: { header: Header<TData, TValue> }) {
...
export function DataTableSpacerRow({ colSpan, height }: { colSpan: number; height: number }) {
...
export function DataTableLoadingRows<TData, TValue>({
  columns,
  loadingRows,
}: {
...
export function DataTableVirtualizedRows<TData>({
  columns,
  rows,
  virtualItems,
  paddingTop,
...
export function DataTableScrollContainer<TData>({
  shouldVirtualize,
  containerStyle,
  virtualParentRef,
  stickyHeader,
...
export function DataTableBodyContent<TData, TValue>({
  columns,
  rows,
  loading,
  loadingRows,
