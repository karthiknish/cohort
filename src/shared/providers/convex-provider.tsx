...
export function ConvexClientProvider({ children, initialToken }: ConvexClientProviderProps) {
    ...
    if (useBetterAuth) {
        ...
        // Official @convex-dev/better-auth provider.
        // This replaces the custom useAuthFromBetterAuth hook that caused
        // React error #301 (Too many re-renders) due to unstable session
        // object references in useMemo deps. The official provider handles
        // token fetching, caching, and session state internally without
