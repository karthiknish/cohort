...
function formatClientTime(value: string | number | Date | null | undefined, formatStr: string): string | null {
 ...
 */
export function useClientFormattedTime(value: string | number | Date | null | undefined, formatStr: string): string | null {
