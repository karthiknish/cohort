    ...
    return [
        {
            ...
            teamMembers: [
                { id: 'preview-member-tech-1', name: 'Alex Morgan', role: 'Account Manager' },
                { id: 'preview-member-tech-2', name: 'Jordan Lee', role: 'Strategist' },
                { id: 'preview-member-tech-3', name: 'Mia Thompson', role: 'Creative Lead' },
            ],
            createdAt: now,
            updatedAt: now,
        },
        {
            ...
            teamMembers: [
                { id: 'preview-member-startup-1', name: 'Priya Patel', role: 'Account Manager' },
                { id: 'preview-member-startup-2', name: 'Sam Chen', role: 'Performance Marketer' },
                { id: 'preview-member-startup-3', name: 'Lena Ortiz', role: 'Lifecycle Strategist' },
            ],
            createdAt: now,
            updatedAt: now,
        },
        {
            ...
            teamMembers: [
                { id: 'preview-member-retail-1', name: 'Taylor Kim', role: 'Account Manager' },
                { id: 'preview-member-retail-2', name: 'Casey Rivera', role: 'Creative' },
                { id: 'preview-member-retail-3', name: 'Noah Bennett', role: 'Email Specialist' },
            ],
            createdAt: now,
            updatedAt: now,
        },
    ...
    return [
        {
            ...
            teamMembersCount: clients[0]?.teamMembers.length ?? 3,
            openTaskCount: 7,
        ...
        },
        {
            ...
            teamMembersCount: clients[1]?.teamMembers.length ?? 3,
            openTaskCount: 5,
        ...
        },
        {
            ...
            teamMembersCount: clients[2]?.teamMembers.length ?? 3,
            openTaskCount: 3,
            activeProjectCount: 1,
            nextMeetingMs: null,
        },
