...
for (const code of Object.keys(SUPPORTED_CURRENCIES) as CurrencyCode[]) {
  EN_US_CURRENCY_MAX_0_BY_CODE.set(
    code,
  ...
  EN_US_CURRENCY_MIN_2_BY_CODE.set(
    code,
    new Intl.NumberFormat('en-US', {
      style: 'currency',
      currency: code,
...
export function formatEnUsCurrencyMaxFractionDigits(
  value: number,
  currency: string = 'USD',
...
for (const code of Object.keys(SUPPORTED_CURRENCIES) as CurrencyCode[]) {
  EN_US_CURRENCY_FORMATTER_CACHE.set(
    `en-US|${code}|maximumFractionDigits:0`,
    new Intl.NumberFormat('en-US', {
      style: 'currency',
      currency: code,
      maximumFractionDigits: 0,
  ...
  EN_US_CURRENCY_FORMATTER_CACHE.set(
    `en-US|${code}|minimumFractionDigits:0|maximumFractionDigits:0`,
    new Intl.NumberFormat('en-US', {
      style: 'currency',
      currency: code,
...
export function formatEnUsCurrency(
  value: number,
  currency = 'USD',
