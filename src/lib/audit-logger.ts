...
export type AuditAction = 'USER_PASSWORD_CHANGE' | 'USER_ACCOUNT_DELETE' | 'WORKSPACE_CREATE' | 'WORKSPACE_DELETE' | 'ADMIN_ROLE_CHANGE' | 'USER_STATUS_CHANGE' | 'FINANCIAL_SETTINGS_UPDATE' | 'INTEGRATION_CONNECT' | 'INTEGRATION_DISCONNECT' | 'INTEGRATION_UPDATE' | 'CLIENT_CREATE' | 'CLIENT_DELETE' | 'PROJECT_CREATE' | 'PROJECT_DELETE';
