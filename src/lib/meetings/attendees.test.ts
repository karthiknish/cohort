...
import { buildMeetingAttendeeDraft, buildMeetingAttendeeSuggestions, parseAttendeeInput, sanitizeMeetingParticipantEmails, } from './attendees';
describe('meeting attendee helpers', () => {
    ...
    it('treats a draft with only the organizer email as missing participants', () => {
        expect(buildMeetingAttendeeDraft({
            selectedEmails: [],
