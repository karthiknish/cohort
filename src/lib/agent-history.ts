...
export function filterAgentHistory(history: AgentConversationSummary[], query: string): AgentConversationSummary[] {
...
export function groupAgentHistory(history: AgentConversationSummary[], options?: {
