...
export const invitationsCollection = adminDb.collection('invitations')
export const workspacesCollection = adminDb.collection('workspaces')
export const clientsCollection = adminDb.collection('clients')
export const leadsCollection = adminDb.collection('leads')
export const blogCollection = adminDb.collection('blog')
export const settingsCollection = adminDb.collection('settings')
export const feedbackCollection = adminDb.collection('ai_feedback')
export const metricsCollection = adminDb.collection('metrics')
