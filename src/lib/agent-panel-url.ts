...
export function applyAgentPanelUrl(searchParams: URLSearchParams, patch: Partial<AgentPanelUrlState>): URLSearchParams {
...
export function agentPanelHref(pathname: string, searchParams: URLSearchParams, patch: Partial<AgentPanelUrlState>): string {
