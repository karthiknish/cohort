...
<head>
  ...
  <style>
    ...
    .shell { border-radius: 24px; overflow: hidden; box-shadow: 0 24px 60px rgba(7, 23, 64, 0.12); }
    ...
    .highlight { background: linear-gradient(180deg, ${EMAIL_COLORS.highlight} 0%, ${EMAIL_COLORS.muted} 100%); border: 1px solid ${EMAIL_COLORS.border}; border-left: 4px solid ${EMAIL_COLORS.brand.primary}; padding: 18px 18px 18px 16px; margin: 18px 0; border-radius: 18px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.75); }
    ...
    .button { display: inline-block; background: ${EMAIL_COLORS.button.primary}; color: #ffffff !important; padding: 13px 24px; border-radius: 14px; text-decoration: none; font-size: 13px; font-weight: 700; letter-spacing: 0.18em; text-transform: uppercase; margin-top: 16px; box-shadow: 0 10px 24px rgba(7, 23, 64, 0.18); }
