...
// =============================================================================
import type { AdMetricsSummary, EnrichedMetricsSummary, EfficiencyBreakdown, } from './types';
/**
 ...
 */
export function calculateHealthScore(summary: AdMetricsSummary, variance?: {
    roasVariance: number;
