...
import type { DerivedMetricInput, DerivedMetricsQueryOptions, DerivedMetricsQueryResult, DerivedMetricRecord, } from './types';
function throwDeprecated(): never {
    throw new ServiceUnavailableError('Client-side Firestore derived metrics storage has been removed. Use server API routes instead.');
}
