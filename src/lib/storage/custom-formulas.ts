...
import type { CustomFormulaRecord, CreateCustomFormulaInput, UpdateCustomFormulaInput, CustomFormulasListResult, } from './types';
function throwDeprecated(): never {
    throw new ServiceUnavailableError('Client-side Firestore formulas storage has been removed. Use Convex customFormulas instead.');
}
