...
export type MetaPlacementOption = { id: string; label: string }
...
export function buildPlacementDetailDraftFromSource(
  source: MetaPlacementDetailSource,
): MetaPlacementDetailDraft {
  return {
...
export function placementDetailToMetaTargetingFields(
  detail: MetaPlacementDetailDraft,
