...
export const DASHBOARD_THEME = {
    ...
    buttons: {
        ...
        outline: 'border-muted/40 bg-background hover:bg-muted/30 hover:text-primary',
        ghost: 'hover:bg-muted/30 hover:text-primary',
    },
    icons: {
...
export const PAGE_TITLES: Record<string, {
    title: string;
    description: string;
}> = {
    clients: {
