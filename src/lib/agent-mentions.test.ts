...
import { formatAgentMentionMarkup, mergeAgentMentions, parseAgentMentionsFromText, } from './agent-mentions';
describe('agent-mentions', () => {
    it('formats structured mention markup', () => {
        expect(formatAgentMentionMarkup({ id: 'c1', name: 'Acme', type: 'client' })).toBe('@[Acme](client:c1)');
    });
