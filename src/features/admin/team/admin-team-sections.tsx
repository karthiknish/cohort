...
type AdminTeamSummaryCardsProps = {
  summary: { total: number; active: number; admins: number; allocated: number }
  loading: boolean
}
...
export function AdminTeamInviteDialog({
  inviteOpen,
  inviteEmail,
  inviteEmailTrimmed,
  inviteEmailValid,
...
export function AdminTeamDirectorySection({
  loading,
  internalUsers,
  filteredUsers,
  hasActiveFilters,
...
}: AdminTeamDirectorySectionProps) {
  return (
    <Card className="border-muted/60 bg-background">
  ...
  return (
    <AdminPageShell
      ...
      actions={
        <>
          ...
          <AdminTeamInviteDialog
            inviteOpen={inviteOpen}
            inviteEmail={inviteEmail}
            inviteEmailTrimmed={inviteEmailTrimmed}
    ...
    >
      ...
      <AdminTeamDirectorySection
        ...
        createRoleChangeHandler={createRoleChangeHandler}
        createAdminToggleHandler={createAdminToggleHandler}
