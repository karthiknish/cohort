...
export function AdminFeaturesToolbarActions({
  refreshing,
  onRefresh,
}: {
  refreshing: boolean
...
export function AdminFeaturesDeleteDialog({
  open,
  featureToDelete,
  isDeleting,
  onOpenChange,
  onConfirm,
}: AdminFeaturesDeleteDialogProps) {
  return (
...
export function AdminFeaturesPageContent({
  isPreviewMode,
  features,
  featuresQueryError,
  refreshing,
