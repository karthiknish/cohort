...
import type { ClientRecord, TeamMemberField as PageTeamMemberField } from './admin-clients-types'

type TeamMemberFieldRowProps = {
  member: PageTeamMemberField
  index: number
...
export function AdminClientsPageContent(props: AdminClientsPageContentProps) {
  ...
  return (
    <>
      ...
      <Dialog open={isTeamDialogOpen} onOpenChange={onTeamDialogChange}>
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={onCancelTeamDialog} disabled={addingMember}>
              Cancel
            </Button>
            <Button type="button" onClick={onConfirmAddTeamMember} disabled={addingMember}>
