...
import { AdminClientsNewClientForm, AdminClientsWorkspaceList, } from './admin-clients-page-content-sections';
...
export function AdminClientsWorkspaceManagementCard({ assignableUsers, clientName, clientAccountManager, teamMemberFields, clientSaving, clientsLoading, clientsCount, clientsError, workspaceQueryError, clientSearch, filteredClients, unmatchedByClientId, nextCursor, loadingMore, addingMember, clientPendingMembersId, deletingClientId, removingTeamMemberKey, updatingMemberRoleKey, onFormSubmit, onClientNameChange, onAccountManagerChange, onAccountManagerInputChange, onAddTeamMemberField, onUpdateTeamMemberName, onUpdateTeamMemberRole, onRemoveTeamMemberField, onResetClientForm, onClientSearchChange, onRequestAddTeamMember, onRequestDeleteClient, onRemoveTeamMember, onEditTeamMemberRole, onLoadMore, }: AdminClientsWorkspaceManagementCardProps) {
    return (<Card>
      ...
      <CardContent className="space-y-6">
        <AdminClientsNewClientForm assignableUsers={assignableUsers} clientName={clientName} clientAccountManager={clientAccountManager} teamMemberFields={teamMemberFields} clientSaving={clientSaving} onFormSubmit={onFormSubmit} onClientNameChange={onClientNameChange} onAccountManagerChange={onAccountManagerChange} onAccountManagerInputChange={onAccountManagerInputChange} onAddTeamMemberField={onAddTeamMemberField} onUpdateTeamMemberName={onUpdateTeamMemberName} onUpdateTeamMemberRole={onUpdateTeamMemberRole} onRemoveTeamMemberField={onRemoveTeamMemberField} onResetClientForm={onResetClientForm}/>

        <AdminClientsWorkspaceList clientsLoading={clientsLoading} clientsCount={clientsCount} clientsError={clientsError} workspaceQueryError={workspaceQueryError} clientSearch={clientSearch} filteredClients={filteredClients} unmatchedByClientId={unmatchedByClientId} nextCursor={nextCursor} loadingMore={loadingMore} addingMember={addingMember} clientPendingMembersId={clientPendingMembersId} deletingClientId={deletingClientId} removingTeamMemberKey={removingTeamMemberKey} onClientSearchChange={onClientSearchChange} onRequestAddTeamMember={onRequestAddTeamMember} onRequestDeleteClient={onRequestDeleteClient} onRemoveTeamMember={onRemoveTeamMember} onEditTeamMemberRole={onEditTeamMemberRole} updatingMemberRoleKey={updatingMemberRoleKey} onLoadMore={onLoadMore}/>
      </CardContent>
    </Card>);
}
