...
import { buildClientAllocationSummary, countUnmatchedClientAllocations, dedupeClientTeamMembers, filterAllocationClients, getAssignableWorkspaceUsers, normalizeAllocationUsers, } from './client-allocation';
describe('client allocation helpers', () => {
    ...
    it('dedupes manager and team members by normalized name', () => {
        expect(dedupeClientTeamMembers('Alex Chen', [
