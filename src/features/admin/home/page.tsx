...
const ADMIN_WORKSPACE_LINK_ACTION = (<Button asChild variant="ghost" size="sm">
    <Link href="/dashboard">
      Workspace
...
export default function AdminPage() {
    ...
    const { results: usersPage } = usePaginatedQuery(api.adminUsers.listUsers, !isPreviewMode && workspaceId ? { workspaceId, includeAllWorkspaces } : 'skip', { initialNumItems: 50 });
    ...
    const statsLoading = !isPreviewMode && (usersPage === undefined || clientsRealtime === undefined);
