    ...
    <Card className={cn(DASHBOARD_THEME.cards.base, 'flex h-full items-center gap-3 p-4')}>
      ...
      <div className="min-w-0 flex-1 space-y-0.5">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {loading ? (
            ...
            <Badge variant="secondary" className="font-normal text-emerald-700 dark:text-emerald-400">
              Connected
            </Badge>
          ) : (
            <Badge variant="outline" className="font-normal">
      ...
      <div className="shrink-0">
        {loading ? (
          ...
          <Button type="button" className={getButtonClasses('primary')} disabled={!canSchedule} onClick={onConnect}>
            Connect
          </Button>
        )}
      </div>
