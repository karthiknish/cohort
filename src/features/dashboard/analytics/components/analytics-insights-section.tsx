                            ...
                            {algorithmic.flatMap((group) =>
                                group.suggestions.map((suggestion) => (
                                    <div
                                        ...
                                        className={cn(
                                            "relative overflow-hidden rounded-xl border p-4 shadow-sm motion-chromatic hover:shadow-md",
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 flex items-center gap-2.5 rounded-xl bg-background/60 p-2.5 text-xs font-bold text-foreground shadow-sm motion-chromatic hover:bg-background/80">
