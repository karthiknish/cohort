      ...
      <CardContent className="pt-0">
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {filteredPages.map((page) => {
            ...
            return (<Link key={page.href} href={page.href} className="group flex items-center gap-3 rounded-lg border border-muted/40 p-3 motion-chromatic hover:border-accent/40 hover:bg-muted/30">
