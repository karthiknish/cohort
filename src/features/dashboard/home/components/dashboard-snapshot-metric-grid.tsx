          ...
          <FadeInItem key={metric.label}>
            <Card
              className={cn(
                ...
                'overflow-hidden border-muted/50 shadow-sm transition-[box-shadow,transform] hover:-translate-y-0.5 hover:shadow-md motion-reduce:hover:translate-y-0',
            ...
            >
              ...
              <CardContent className="pt-0">
                {loading ? (
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground">{metric.helper}</p>
                )}
              </CardContent>
            </Card>
          </FadeInItem>
