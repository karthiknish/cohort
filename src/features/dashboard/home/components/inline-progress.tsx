 ...
 */
export function InlineProgress({ value, max = 100, label, showPercentage = true, size = 'default', className, }: {
    value: number;
    max?: number;
    label?: string;
    ...
    return (<div className={cn('flex items-center gap-3', className)}>
      ...
      {showPercentage && (<span className="text-sm text-muted-foreground min-w-fit tabular-nums">
