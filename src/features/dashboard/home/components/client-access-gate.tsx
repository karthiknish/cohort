...
export function ClientAccessGate({ children }: PropsWithChildren) {
    ...
    if (error) {
        return (<Card className="mx-auto max-w-lg border-destructive/40 bg-destructive/5">
        <CardHeader>
        ...
        <CardContent className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          {canManageClients ? (<Button asChild variant="outline" className="gap-2">
    ...
    if (clients.length === 0) {
        return (<Card className="mx-auto max-w-2xl overflow-hidden border-muted/60 bg-background shadow-sm">
        <CardHeader>
        ...
        <CardContent className="flex flex-col gap-3 sm:flex-row sm:items-center">
          {canManageClients ? (<Button asChild>
    ...
    if (!selectedClientId) {
        return (<Card className="mx-auto max-w-xl border-accent/30 bg-accent/5">
        <CardHeader>
