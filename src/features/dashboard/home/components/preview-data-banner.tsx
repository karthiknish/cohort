...
export function PreviewDataBanner({ className }: PreviewDataBannerProps) {
    ...
    return (<section aria-label={isPreviewMode ? 'Preview mode' : 'Sample data banner'} className={cn('relative overflow-hidden rounded-lg border motion-chromatic-lg', isPreviewMode
      ...
      <div className="relative flex items-center justify-between gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <Button size="sm" variant={isPreviewMode ? 'outline' : 'default'} onClick={togglePreviewMode} className={cn('gap-2 motion-chromatic', isPreviewMode
