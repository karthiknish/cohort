    ...
    return (<Card className="shadow-sm">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-4">
          ...
          {mixedCurrencies && (<Badge variant="secondary" className="text-[10px] uppercase font-bold tracking-wide">
              Mixed currencies
            </Badge>)}
        </div>
      </CardHeader>
      <CardContent className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {insights.roasLeader && (<div className="rounded-xl border bg-card p-3">
        ...
        {insights.revenueLeader && (<div className="rounded-xl border bg-card p-3">
        ...
        {insights.spendLeader && (<div className="rounded-xl border bg-card p-3">
        ...
        {insights.conversionsLeader && (<div className="rounded-xl border bg-card p-3">
            <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
