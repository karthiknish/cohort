import type { CollaborationAttachment, CollaborationChannelType, CollaborationMessage, CollaborationMessageFormat, } from '@/types/collaboration';
...
export function previewPendingAttachmentToCollaborationAttachment(attachment: PendingAttachment): CollaborationAttachment {
    return {
...
export function mapCollaborationMessageRow(row: unknown, { fallbackChannelType, fallbackClientId = null, fallbackProjectId = null, fallbackSenderId = null, fallbackSenderName = 'Unknown teammate', fallbackSenderRole = null, fallbackThreadRootId = null, fallbackCreatedAtIso = null, }: MapCollaborationMessageRowOptions): CollaborationMessage | null {
    ...
    return {
        ...
        createdAt: typeof item.createdAtMs === 'number'
        ...
        mentions: Array.isArray(item.mentions) && item.mentions.length > 0
            ...
            : undefined,
        reactions: Array.isArray(item.reactions) && item.reactions.length > 0
