  ...
  return (
    <>
      <button
        type="button"
        className={cn(
          "group relative block max-w-md overflow-hidden rounded-lg border border-muted/60 bg-muted/10 cursor-pointer motion-chromatic hover:border-muted my-2",
          className
        )}
      ...
      >
        <div className="relative overflow-hidden">
          ...
          <LazyImage
            ...
            alt={fileName}
            className={cn(
              "max-h-80 w-auto object-contain motion-chromatic-lg",
              isLoading && "opacity-0",
