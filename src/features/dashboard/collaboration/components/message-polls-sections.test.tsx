...
describe('message polls sections', () => {
    it('renders poll card sections', () => {
        ...
        <PollOptionRow ui={{
            ...
            }} handleToggleOption={vi.fn()} option={poll.options[0]!} percentage={67} sortedOptions={poll.options} voteCount={2}/>
        <PollCardFooterActions ui={{
                canEnd: true,
                canVote: true,
                hasVoted: false,
                isExpired: false,
                isVoting: false,
                showResults: false,
            }} onEndPoll={vi.fn()} onShowResults={vi.fn()} onVote={vi.fn()} selectedOptionsCount={1}/>
      </>);
    ...
    it('renders create poll dialog sections and quick trigger', () => {
        ...
        <CreatePollFormFields onAddOption={vi.fn()} onOptionChange={vi.fn()} onQuestionChange={vi.fn()} onRemoveOption={vi.fn()} options={[{ id: '1', text: '' }, { id: '2', text: 'Second' }]} question="Launch poll?"/>
