...
export const PROJECTS_THEME = {
  ...
  sheet: {
    content:
      'flex size-full flex-col border-l border-border/70 bg-card p-0 shadow-xl sm:max-w-lg',
    header:
    ...
    footer:
      'shrink-0 flex flex-col-reverse gap-2 border-t border-border/60 bg-muted/15 px-5 py-4 sm:flex-row sm:justify-end',
  },
} as const;
