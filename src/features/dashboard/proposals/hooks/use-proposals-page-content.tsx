...
export function useProposalsPageContent() {
    ...
    const { handleVersionRestored, handleStartProposal, handleResumeProposalInModal, handleContinueEditingInModal, handlePreviewRefresh, handlePreviewRequestDelete, handlePreviewDownloadDeck, } = useProposalPageInteractions({
        routerPush: push,
        setIsWizardOpen,
        setFormState,
        setCurrentStep,
