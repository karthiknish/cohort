...
export function useProposalWizard(options: UseProposalWizardOptions = {}): UseProposalWizardReturn {
    ...
    const setFormState = (state: ProposalFormData | ((prev: ProposalFormData) => ProposalFormData), options: FormStateUpdateOptions = {}) => {
    ...
    const handleSocialHandleChange = (handle: string, value: string) => {
        setFormState((prev) => ({
            ...prev,
            marketing: {
                ...prev.marketing,
