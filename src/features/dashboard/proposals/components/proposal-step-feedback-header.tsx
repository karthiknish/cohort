...
export function ProposalStepFeedbackHeader({ completedRequiredFields, currentStep, hasErrors, requiredFieldCount, stepDescription, stepTitle, totalSteps, validationMessageCount, }: {
    ...
    return (<div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
