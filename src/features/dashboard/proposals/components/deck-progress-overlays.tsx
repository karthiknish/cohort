...
export function ProposalGenerationOverlay({ isSubmitting, isPresentationReady = false }: ProposalGenerationOverlayProps) {
    ...
    return (<DeckProgressOverlayShell className="fixed inset-0 z-[2100] flex items-center justify-center animate-in fade-in bg-background/40 backdrop-blur-xl duration-500">
...
export function DeckProgressOverlay({ stage, isVisible }: DeckProgressOverlayProps) {
    ...
    return (<DeckProgressOverlayShell className="fixed inset-0 z-[2100] flex flex-col items-center justify-center gap-6 bg-background/80 backdrop-blur-sm">
