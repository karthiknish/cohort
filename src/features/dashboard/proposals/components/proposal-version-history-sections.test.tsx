...
describe('proposal version history sections', () => {
    it('renders the trigger and menu content', () => {
        ...
        <ProposalVersionHistoryMenuContent handleSaveVersion={vi.fn()} latestVersion={version} loading={false} proposalId="p1" restoring={false} saving={false} setPreviewVersion={vi.fn()} setRestoreConfirmVersion={vi.fn()} versions={[version]}/>
      </>);
    ...
    it('renders the preview and restore dialogs', () => {
        ...
        <ProposalVersionRestoreDialog open onOpenChange={vi.fn()} handleRestoreVersion={vi.fn()} restoreConfirmVersion={version as never} restoring={false}/>
      </>);
