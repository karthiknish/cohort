...
import { ProposalStepIndicatorProgressBar, ProposalStepIndicatorSummary, } from './proposal-step-indicator-sections';
describe('proposal step indicator sections', () => {
    it('renders the summary row', () => {
        const markup = renderToStaticMarkup(<ProposalStepIndicatorSummary activeStepTitle="Company Information" currentStep={1} percentage={40} totalSteps={5}/>);
