'use client';
export function ProposalStepIndicatorSummary({ activeStepTitle, currentStep, percentage, totalSteps, }: {
    activeStepTitle: string;
    currentStep: number;
    percentage: number;
    totalSteps: number;
}) {
    return (<div className="flex items-center justify-between text-xs font-medium">
