...
function phaseLabel(phase: ProjectDocumentImportPhase, statusMessage: string | null, errorMessage: string | null) {
    if (phase === 'error')
...
export function ProjectsDocumentImportOverlay({ phase, statusMessage, errorMessage, visible, onCancel, }: ProjectsDocumentImportOverlayProps) {
    if (!visible)
        return null;
