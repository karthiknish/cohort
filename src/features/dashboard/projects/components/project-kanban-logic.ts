...
export function projectKanbanReducer(state: ProjectKanbanState, action: ProjectKanbanAction): ProjectKanbanState {
    switch (action.type) {
        case 'startDrag':
...
export function resolveProjectKanbanMoveTarget(currentStatus: ProjectStatus, direction: 'previous' | 'next'): ProjectStatus | null {
