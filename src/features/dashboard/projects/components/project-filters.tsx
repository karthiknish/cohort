    ...
    return (<div className="flex shrink-0 items-center gap-1.5">
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button variant="outline" size="icon" onClick={onToggleSortDirection} className="size-9 shrink-0 border-border/60 shadow-sm" aria-label={`Sort ${sortDirection === 'asc' ? 'descending' : 'ascending'}`}>
