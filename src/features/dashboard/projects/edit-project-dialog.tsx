...
export function EditProjectDialog({ project, open, onOpenChange, onProjectUpdated }: EditProjectDialogProps) {
    ...
    return (<>
      <Dialog open={open} onOpenChange={handleDialogOpenChange}>
        <DialogContent className="sm:max-w-[540px]">
          <form onSubmit={handleSubmit}>
            ...
            <EditProjectFormFields loading={loading} name={name} description={description} status={status} clientId={clientId} startDate={startDate} endDate={endDate} tags={tags} tagInput={tagInput} validationErrors={validationErrors} clients={clients} onDispatch={dispatch} onAddTag={handleAddTag} onRemoveTag={handleRemoveTag} onTagKeyDown={handleTagKeyDown} formatStatusLabel={formatStatusLabel}/>
      ...
      <ConfirmDialog open={open && discardDialogOpen} onOpenChange={setDiscardDialogOpen} title="Discard unsaved changes?" description="You have unsaved changes in this project. Closing now will discard them." confirmLabel="Discard changes" cancelLabel="Keep editing" variant="warning" onConfirm={handleConfirmDiscard} onCancel={handleCancelDiscard}/>
    </>);
}
