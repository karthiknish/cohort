...
describe('ActivityItem', () => {
    it('renders a semantic details button instead of a role button wrapper', () => {
        const markup = renderToStaticMarkup(<ActivityItem activity={activity} isSelected={false} showReactions={null} comments={[]} onSelectionChange={vi.fn()} onTogglePin={vi.fn()} onMarkAsRead={vi.fn()} onAddReaction={vi.fn()} onAddComment={vi.fn()} onShowReactionsChange={vi.fn()} onViewDetails={vi.fn()} currentUserName="Alex Kim"/>);
