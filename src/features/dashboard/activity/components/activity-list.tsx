...
import {
  ...
  ActivityListErrorState,
  ActivityListGroupedBody,
  ActivityListLoadMoreFooter,
  ActivityListLoadingSkeleton,
  ActivityListSelectAllHeader,
  ActivityListVirtualizedBody,
  useActivityListClearFilters,
  useActivityListData,
  useActivityListInfiniteScroll,
} from './activity-list-sections'
...
export function ActivityList({
  ...
  } = useActivityListData({ activities, typeFilter, searchQuery, statusFilter, sortBy })
      ...
      >
        <div className="p-4 sm:p-6">
          {loading && sortedActivities.length === 0 ? (
            ...
            <ActivityListErrorState error={error} onRetry={onRetry} />
            ...
            <ActivityListVirtualizedBody
              activityFlatRows={activityFlatRows}
              activityVirtualizer={activityVirtualizer}
              virtualContainerStyle={virtualContainerStyle}
