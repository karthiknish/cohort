...
export function TasksPageWorkspace({
  filters,
  rawSearchQuery,
  onSearchChange,
  projectFilter,
  ...
  projectFilter: { id: string | null; name: string | null }
  onClearProjectFilter: () => void
  visibleTasks: TaskRecord[]
  selectedTasks: TaskRecord[]
  selectedTaskIds: Set<string>
  hasSelection: boolean
  bulkState: { active: boolean; label: string; progress: number }
  ...
  const handleFilterStatusChange = useCallback(
    (status: string) => filters.handleStatusChange(status as TaskStatus | 'all'),
    [filters],
  )
    ...
    <>
      {initialLoading ? (
        ...
        <TaskSummaryCards
          ...
          onStatusCardClick={onSummaryStatusClick}
        />
      )}
            ...
            >
              {filters.viewMode === 'board' ? (
                <TaskKanban
                  ...
                  onEmptyClearFilters={onClearListFilters}
                  onEmptyCreateTask={onNewTaskClick}
