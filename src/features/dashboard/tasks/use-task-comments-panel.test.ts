...
import {
  ...
  taskCommentsPanelReducer,
} from './use-task-comments-panel'
...
describe('taskCommentsPanelReducer', () => {
  it('starts a reply and clears edit/composer state', () => {
    const editing = taskCommentsPanelReducer(
      { ...INITIAL_TASK_COMMENTS_PANEL_STATE, composerValue: 'draft', editingCommentId: 'comment-9' },
      { type: 'startReply', comment },
    )
