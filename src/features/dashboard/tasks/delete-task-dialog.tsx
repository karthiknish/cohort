...
export function DeleteTaskDialog({ open, onOpenChange, task, deleting, onConfirm, }: DeleteTaskDialogProps) {
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={onConfirm} disabled={deleting} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
            {deleting ? (<span className="inline-flex items-center gap-2">
