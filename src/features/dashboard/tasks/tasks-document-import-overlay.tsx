...
export function TasksDocumentImportOverlay({
  phase,
  statusMessage,
  errorMessage,
  visible,
  onCancel,
}: TasksDocumentImportOverlayProps) {
  ...
  return (
    <div
      className={cn(
        ...
        phase === 'dragging' ? 'pointer-events-none bg-primary/5 backdrop-blur-[2px]' : 'pointer-events-auto bg-background/80 backdrop-blur-sm',
      )}
      role="presentation"
    >
      <div
        className={cn(
          'flex max-w-lg flex-col items-center gap-6 rounded-3xl border border-dashed px-8 py-10 text-center shadow-lg',
