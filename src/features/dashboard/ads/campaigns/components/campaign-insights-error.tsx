...
export function CampaignInsightsError({ message, onRetry, retrying = false, className, }: CampaignInsightsErrorProps) {
    return (<div className={cn(ADS_PAGE_THEME.emptyState, 'px-6 py-14', className)} role="alert">
      ...
      {onRetry ? (<Button type="button" variant="outline" size="sm" className="gap-1.5 rounded-full" onClick={onRetry} disabled={retrying} aria-busy={retrying}>
