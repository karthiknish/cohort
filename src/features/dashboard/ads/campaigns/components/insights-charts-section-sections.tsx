...
export function PerformanceOverviewChartSection({
  chartMetrics,
  insightsLoading,
  displayCurrency,
}: {
...
export function EngagementTrendsChartSection({
  engagementChartData,
  insightsLoading,
  formatters,
}: {
...
export function ConversionsChartSection({
...
export function CostEfficiencyChartSection({
  conversionsChartData,
  insightsLoading,
  formatters,
}: {
...
export function ReachVsImpressionsChartSection({
  reachChartData,
  formatters,
}: {
