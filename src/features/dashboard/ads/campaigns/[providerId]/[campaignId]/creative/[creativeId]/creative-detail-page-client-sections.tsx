...
} from '@/features/dashboard/ads/creative/components/creative-social-preview'
...
export function CreativeDetailPageContent({
  creative,
  previewCreative,
  backUrl,
  campaignName,
...
}: CreativeDetailPageContentProps) {
  return (
    <div className={ADS_PAGE_THEME.innerContainer}>
      <CreativeHeader
        ...
        onRefreshPerformance={onRefreshPerformance}
      />
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-start">
        <CreativeSocialPreview
          ...
          onPreviewHeadlineIndexChange={onPreviewHeadlineIndexChange}
          onPreviewDescriptionIndexChange={onPreviewDescriptionIndexChange}
        />
        ...
        <div className="flex flex-col lg:col-span-7">
          <CreativeEditorTabs
            ...
            onChangeLandingPage={onChangeLandingPage}
