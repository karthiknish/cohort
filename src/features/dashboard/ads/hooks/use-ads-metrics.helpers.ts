...
export function isAdsProviderId(providerId: string | null | undefined): boolean {
    ...
    if (!raw || NON_ADS_PROVIDER_ALIASES.has(raw))
        return false;
 ...
 */
export function metricsForTableDisplay(dailyMetrics: MetricRecord[], summary: MetricsSummary | null | undefined): MetricRecord[] {
...
export function hasAdsMetricActivity(processedMetrics: MetricRecord[], serverSideSummary: MetricsSummary | null | undefined, adsInsightsSummary: AdsInsightsSummary | null | undefined): boolean {
...
export function buildProviderSummariesFromServer(providers: Record<string, ProviderSummary> | null | undefined): Record<string, ProviderSummary> {
    if (!providers) {
        return {};
    }
