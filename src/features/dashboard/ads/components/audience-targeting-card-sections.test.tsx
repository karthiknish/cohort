...
describe('audience targeting card sections', () => {
    ...
    it('renders the empty content state', () => {
        ...
        const markup = renderToStaticMarkup(<AudienceTargetingContent expandedId={null} formatAgeRange={formatAgeRange} insights={null} onEdit={onEdit} onToggleExpanded={onToggleExpanded} targeting={[]}/>);
    ...
    it('renders the summary and expanded targeting details', () => {
        const onEdit = vi.fn();
        const onToggleExpanded = vi.fn();
        const markup = renderToStaticMarkup(<AudienceTargetingContent expandedId="entity-1" formatAgeRange={formatAgeRange} insights={insights} onEdit={onEdit} onToggleExpanded={onToggleExpanded} targeting={targeting}/>);
