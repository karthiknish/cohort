...
function CreativeImage({ src, alt, fallbackSrc }: { src?: string; alt?: string; fallbackSrc?: string }) {
  ...
  if (!src || error) return <ImageOff className="size-8 text-muted-foreground" />
...
function getTypeIcon(type: string) {
  ...
  if (normalized.includes('carousel')) return <GalleryHorizontal className="size-4" aria-hidden />
  if (normalized.includes('dynamic_product')) return <ShoppingBag className="size-4" aria-hidden />
  if (normalized.includes('dynamic_creative')) return <Layers className="size-4" aria-hidden />
  if (normalized.includes('boosted') || normalized.includes('page_post')) return <Link2 className="size-4" aria-hidden />
  if (normalized.includes('video')) return <Video className="size-4" />
  if (normalized.includes('image') || normalized.includes('display')) return <ImageIcon className="size-4" />
