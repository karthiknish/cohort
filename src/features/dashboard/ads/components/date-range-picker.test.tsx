...
describe('DateRangePicker', () => {
    it('renders the lifetime preset when a campaign lifetime range is provided', () => {
        const markup = renderToStaticMarkup(<DateRangePicker value={value} onChange={vi.fn()} lifetimeRange={{
    ...
    it('does not render the lifetime preset when no lifetime range is available', () => {
        const markup = renderToStaticMarkup(<DateRangePicker value={value} onChange={vi.fn()}/>);
