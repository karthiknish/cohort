  ...
  return (
    <div
      className={cn(
        ...
        done ? 'border-success/25 bg-success/5' : 'border-primary/15 bg-primary/[0.03]',
      )}
    >
  ...
  return (
    <Card className={ADS_PAGE_THEME.surfaceCardHighlight}>
      ...
      <CardContent className="space-y-4">
        ...
        {googleNeedsAccountSelection && !googleSetupMessage ? (
          <SetupTaskRow
            done={false}
              ...
              <>
                ...
                >
                  <SelectTrigger className="w-full min-w-[12rem] sm:max-w-xs">
                    <SelectValue
                      placeholder={loadingMetaAccountOptions ? 'Loading accounts…' : 'Meta ad account'}
                    />
                  </SelectTrigger>
                  <SelectContent>
