...
export type GoogleCampaignObjective = 'SALES' | 'LEADS' | 'WEBSITE_TRAFFIC' | 'BRAND_AWARENESS_AND_REACH' | 'APP_PROMOTION';
...
export const GOOGLE_BIDDING_STRATEGIES: Record<string, {
    value: string;
    label: string;
    description: string;
}[]> = {
