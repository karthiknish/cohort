...
import { ConnectionDialogBody, ConnectionDialogFooterActions, ConnectionDialogHeader, type ConnectionStep, } from './connection-dialog-sections';
// =============================================================================
// TYPES
// =============================================================================
// =============================================================================
...
// =============================================================================
export const ConnectionDialog = function ConnectionDialog({ open, onOpenChange, providerId, providerIcon: Icon, onConnect, isConnecting, connectionStep, error, onRetry, }: ConnectionDialogProps) {
    ...
    return (<Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <ConnectionDialogBody connectionStep={connectionStep} error={error} errorGuidance={errorGuidance} isInProgress={isInProgress} providerInfo={providerInfo} showPreConnect={showPreConnect} providerId={providerId}/>
...
// =============================================================================
export const DisconnectDialog = function DisconnectDialog({ open, onOpenChange, providerName, onConfirm, isDisconnecting, }: DisconnectDialogProps) {
    ...
    const handleClearHistoricalDataChange = (checked: boolean | 'indeterminate') => {
    ...
    return (<AlertDialog open={open} onOpenChange={handleOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <div className="rounded-md border border-muted/60 p-3">
            <label htmlFor={checkboxId} className="flex items-start gap-3 text-sm">
              <Checkbox id={checkboxId} checked={clearHistoricalData} onCheckedChange={handleClearHistoricalDataChange} disabled={isDisconnecting} aria-label="Clear historical data"/>
              <span>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={handleConfirm} disabled={isDisconnecting} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
            {isDisconnecting ? (<>
