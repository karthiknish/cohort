...
import {
  META_LOOKALIKE_COUNTRIES,
  META_LOOKALIKE_RATIO_PRESETS,
} from '@/lib/meta-lookalike-spec'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function MetaAudiencesPanel({ workspaceId, clientId }: MetaAudiencesPanelProps) {
  ...
  const sourceAudiences = useMemo(
    () => audiences.filter((row) => !isLookalikeSubtype(row.subtype)),
    [audiences],
  )
  ...
  }, [clientId, deleteAudience, pendingDelete, workspaceId])
    ...
    void createLookalikeAudience({
      ...
      .catch((error) => {
        reportConvexFailure({
          ...
          fallbackMessage:
            'Meta requires a populated source audience (often 100+ people in the selected country).',
        })
      })
      .finally(() => {
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <SelectContent>
                {META_LOOKALIKE_COUNTRIES.map((country) => (
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <SelectContent>
                {META_LOOKALIKE_RATIO_PRESETS.map((preset) => (
            ...
            {audiences.map((audience) => (
              ...
              >
                ...
                <div className="flex shrink-0 items-center gap-1">
                  {isLookalikeSubtype(audience.subtype) ? (
