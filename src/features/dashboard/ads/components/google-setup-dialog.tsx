      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={selectedAccountId || undefined} onValueChange={onAccountSelectionChange} disabled={loadingAccounts || initializing || accountOptions.length === 0}>
              <SelectTrigger>
            ...
            {noAccounts ? (<p className="text-xs text-warning">
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          <Button type="button" variant="outline" onClick={onReloadAccounts} disabled={loadingAccounts || initializing}>
            {loadingAccounts ? (<>
