...
export { PROVIDER_IDS, PROVIDER_INFO, PROVIDER_THEMES, PROVIDER_COLORS, type ProviderId, type ProviderInfo, type ProviderInfoKey, } from '@/lib/themes';
// =============================================================================
// HTTP STATUS CODES
// =============================================================================
...
export const SUCCESS_MESSAGES = {
    ...
    SYNC_COMPLETE_WITH_RETRIES: (providerName: string, retries: number) => `${providerName} metrics refreshed after ${retries} retry(s).`,
