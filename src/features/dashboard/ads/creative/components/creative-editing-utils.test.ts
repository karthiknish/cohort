...
describe('creative-editing-utils', () => {
  ...
  it('detects dirty copy state', () => {
    expect(
      creativeCopyIsDirty(baseCreative, {
        headlines: ['Headline A'],
        descriptions: ['Body A'],
        cta: 'BOOK_NOW',
  ...
  it('merges headlines and descriptions into Meta asset feed spec', () => {
    const merged = mergeMetaAssetFeedSpecForSave(
      baseCreative.assetFeedSpec,
      ['New headline', 'Second headline'],
      ['New body', 'Alt body'],
