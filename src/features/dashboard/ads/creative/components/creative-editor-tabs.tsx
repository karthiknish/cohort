...
import { CreativeEditorDetailsTab, CreativeEditorEditTab, CreativeEditorInsightsTab, } from './creative-editor-tabs-sections';
    ...
    return (<div className="flex flex-col gap-4">
      <Tabs defaultValue="edit" className="w-full">
        ...
        <TabsContent value="insights" className="mt-0 space-y-4">
          <CreativeEditorInsightsTab performanceSummary={tabProps.performanceSummary} onRefreshPerformance={tabProps.onRefreshPerformance} algorithmicInsights={tabProps.algorithmicInsights}/>
        </TabsContent>

        <TabsContent value="details" className="mt-0 space-y-4">
          <CreativeEditorDetailsTab creative={tabProps.creative} copiedField={tabProps.copiedField} onCopy={tabProps.onCopy}/>
        </TabsContent>
      </Tabs>
    </div>);
}
