...
export function ForYouGreeting() {
    ...
    return (<section className={cn('relative mb-8 overflow-hidden rounded-2xl border border-primary/10', 'bg-card/80 shadow-sm shadow-primary/[0.04] backdrop-blur-sm')} aria-labelledby="for-you-greeting-heading">
      ...
      <div className="relative px-5 py-6 sm:px-7 sm:py-7">
        ...
        <h1 id="for-you-greeting-heading" className="mt-1.5 text-2xl font-semibold tracking-tight text-foreground sm:text-[1.75rem]">
