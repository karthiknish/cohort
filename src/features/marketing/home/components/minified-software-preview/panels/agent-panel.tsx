    ...
    return (<div className="space-y-3">
      <div className="rounded-xl border border-border/40 bg-muted/20 p-3">
        ...
        <div className="space-y-1.5">
          {AGENT_FLOWS.map((flow) => (<div key={flow.id} className="flex items-center justify-between rounded-lg border border-border/30 bg-background/60 px-2.5 py-2">
              <div className="flex items-center gap-2">
                <span className={cn('size-1.5 rounded-full', flow.tone === 'success'
      ...
      <div className="rounded-xl border border-border/40 bg-muted/20 p-3">
        ...
        <div className="space-y-1.5">
          {AGENT_RECENT.map((item) => (<div key={item.id} className="flex items-start gap-2 rounded-lg border border-border/30 bg-background/60 px-2.5 py-2">
