...
export const PROPOSAL_STAGES: readonly { id: string; label: string; count: number; tone: PreviewTone }[] = [
...
export const PROPOSALS: readonly { id: string; title: string; stage: string; tone: PreviewTone; value: string }[] = [
...
export const AGENT_FLOWS: readonly { id: string; label: string; status: string; tone: PreviewTone }[] = [
...
export const AGENT_RECENT: readonly { id: string; text: string; time: string; tone: PreviewTone }[] = [
