...
export function MinifiedSoftwarePreview() {
    ...
    return (<section className="relative mx-auto w-full max-w-5xl" aria-label="Interactive product preview (sample data)">
      <div aria-hidden="true" className="absolute inset-x-16 -top-8 h-32 rounded-full bg-accent/15 blur-3xl"/>
      <div aria-hidden="true" className="absolute -right-8 top-16 size-40 rounded-full bg-info/10 blur-3xl"/>

      <div className="relative perspective-[1600px] motion-reduce:perspective-none" onMouseEnter={preview.handlePreviewMouseEnter} onMouseLeave={preview.handlePreviewMouseLeave} onMouseMove={preview.handlePreviewMouseMove}>
