...
function GlowOrb({ shape }: {
    ...
    return (<m.span aria-hidden className={cn('absolute inline-block rounded-full', shape.className)} style={sizeStyle} initial={shape.initial} animate={shape.animate} transition={transition}/>);
}
