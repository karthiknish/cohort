...
export const PLATFORM_BARS: readonly { label: string; slug: PlatformBrandSlug; pct: number; value: string; dir: number }[] = [
...
export const ACTIVITY_ITEMS: { Icon: IconType; name: string; detail: string; value: string; positive: boolean }[] = [
