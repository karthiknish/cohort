...
function SettingsPageInner() {
  ...
  return (
    <main id="settings-page" className="mx-auto w-full max-w-3xl space-y-8">
      <SettingsPageHeader isPreviewMode={isPreviewMode} />

      {isPreviewMode ? (
        <p className="rounded-lg border border-dashed border-muted-foreground/30 bg-muted/20 px-4 py-3 text-sm text-muted-foreground">
