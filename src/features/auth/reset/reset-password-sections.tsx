...
export function ResetPasswordErrorState({ verificationError }: { verificationError: string | null }) {
  return (
...
export function ResetPasswordSuccessState({ onReturnToSignIn }: { onReturnToSignIn: () => void }) {
  return (
