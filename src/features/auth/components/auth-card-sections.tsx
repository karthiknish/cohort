...
export function AuthCardHeader({
  ...
  return (
    <div className="space-y-6 px-6 pt-7 pb-2 sm:px-8 sm:pt-8">
        ...
        {AUTH_TAB_OPTIONS.map((tab) => {
          ...
          return (
            <button
              ...
              onClick={onTabClick}
              className={cn(
                'rounded-full px-3 py-2.5 text-sm font-medium transition-[color,background-color,box-shadow]',
                selected
...
>) {
  ...
  return (
    <FadeInStagger
      ...
      as="form"
      className="space-y-4"
      onSubmit={onSubmitSignIn as unknown as FormEventHandler<HTMLDivElement>}
    >
      <FadeInItem as="div">
        <AuthField
          id="signInEmail"
          label="Email address"
          icon={authMailIconSm}
          error={emailError && activeTab === 'signin' ? emailError : null}
        >
          <Input
            id="signInEmail"
            name="email"
            ...
            className={cn(
              authInputClassName,
              emailError && activeTab === 'signin' && 'border-destructive focus-visible:ring-destructive/30',
            )}
      ...
      <FadeInItem as="div">
        <AuthField
          ...
          label="Password"
          icon={authLockIconSm}
          labelAction={authForgotPasswordLink}
        >
          <Input
            id="signInPassword"
            name="password"
...
>) {
  ...
  return (
    <FadeInStagger
      ...
      as="form"
      className="space-y-4"
      onSubmit={onSubmitSignUp as unknown as FormEventHandler<HTMLDivElement>}
    >
      <FadeInItem as="div">
      ...
      <FadeInItem as="div">
        <AuthField
          ...
          label="Work email"
          icon={authMailIconSm}
          error={emailError && activeTab === 'signup' ? emailError : null}
        >
          <Input
            id="signUpEmail"
            name="email"
            ...
            className={cn(
              authInputClassName,
              emailError && activeTab === 'signup' && 'border-destructive focus-visible:ring-destructive/30',
            )}
            disabled={isSubmitting}
          />
        </AuthField>
      ...
      >
        {isSubmitting ? (
          ...
          <svg className="size-4 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
            ...
            />
            <path
              fill={PROVIDER_COLORS.google.green}
              d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
            />
            <path
              fill={PROVIDER_COLORS.google.yellow}
              d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
            />
            <path
              fill={PROVIDER_COLORS.google.red}
...
export function AuthCardTermsFooter() {
  return (
    <p className="border-t border-border/50 bg-muted/15 px-6 py-4 text-center text-[11px] leading-relaxed text-muted-foreground sm:px-8">
