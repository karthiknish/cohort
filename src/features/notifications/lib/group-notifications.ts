...
export function groupNotificationsByDate(notifications: WorkspaceNotification[]): GroupedNotifications {
    ...
    return (['today', 'yesterday', 'earlier'] as const).flatMap((key) => buckets[key].length > 0
