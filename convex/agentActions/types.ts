...
export const OPERATION_ALIASES: Record<string, string> = {
  ...
  summarizemytasks: 'summarizeMyTasks',
  mytasks: 'summarizeMyTasks',
  listmytasks: 'summarizeMyTasks',
  markallnotificationsread: 'markAllNotificationsRead',
  clearnotifications: 'markAllNotificationsRead',
  readallnotifications: 'markAllNotificationsRead',
  listworkspaceclients: 'listWorkspaceClients',
  listclients: 'listWorkspaceClients',
  showworkspaceclients: 'listWorkspaceClients',
