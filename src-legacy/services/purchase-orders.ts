...
export type PurchaseOrderServices = {
    ...
    updatePurchaseOrder: (id: string, input: UpdatePurchaseOrderInput) => Promise<{
        ok: true;
    }>;
    deletePurchaseOrder: (id: string) => Promise<{
        ok: true;
    }>;
    transitionPurchaseOrder: (id: string, action: 'submit' | 'approve' | 'reject' | 'mark_ordered' | 'mark_received' | 'close' | 'cancel', note?: string | null) => Promise<{
        ok: true;
    }>;
};
...
export async function transitionPurchaseOrder(id: string, action: 'submit' | 'approve' | 'reject' | 'mark_ordered' | 'mark_received' | 'close' | 'cancel', note?: string | null) {
