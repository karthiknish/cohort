...
// =============================================================================
import type { PlatformInsight, PlatformInsightResult, GoogleAdsCalculatedMetrics, } from '../shared/insights-types';
/**
 ...
 */
export function generateGoogleAdsInsights(metrics: GoogleAdsRawMetrics, calculated: GoogleAdsCalculatedMetrics): PlatformInsight[] {
