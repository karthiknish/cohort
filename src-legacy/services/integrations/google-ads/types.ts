 ...
 */
export type AssetAutomationType = 'FINAL_URL_EXPANSION_TEXT_ASSET_AUTOMATION' // Auto-generate text assets from final URL
 ...
 */
export type AppCampaignBiddingStrategyGoalType = 'OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA' // Maximize conversions without target CPA
...
export type GoogleCreative = {
    ...
    adGroupName?: string;
    campaignName?: string;
    type: 'RESPONSIVE_SEARCH_AD' | 'RESPONSIVE_DISPLAY_AD' | 'IMAGE_AD' | 'VIDEO_AD' | 'VIDEO_RESPONSIVE_AD' | 'APP_AD' | 'CALL_ONLY_AD' | 'HOTEL_AD' | 'PERFORMANCE_MAX_AD' | 'SMART_DISPLAY_AD' | 'DISPLAY_AD' | 'SEARCH_AD' | 'DEMAND_GEN_MULTI_ASSET_AD' | 'DEMAND_GEN_VIDEO_RESPONSIVE_AD' | 'DEMAND_GEN_CAROUSEL_AD' | 'DEMAND_GEN_PRODUCT_AD' | 'SHOPPING_PRODUCT_AD' | 'OTHER';
    status: 'ENABLED' | 'PAUSED' | 'REMOVED';
    headlines: string[];
    descriptions: string[];
    finalUrls: string[];
...
export type GoogleAudienceTargeting = {
    ...
    incomeRanges: string[];
    // Audiences
    affinityAudiences: Array<{
        id: string;
        name: string;
    }>;
    inMarketAudiences: Array<{
        id: string;
        name: string;
    }>;
