...
export function parseAssetFeedSpecForApi(assetFeedSpec?: string | unknown[]): Record<string, unknown> | undefined {
...
export function extractVideoThumbnailFromAssetFeed(assetFeedSpec?: string | unknown[]): {
    imageUrl?: string;
    imageHash?: string;
} {
...
export function applyInstagramPlacement(objectStorySpec: Record<string, unknown>, options: {
