 ...
 */
export type LegacyAdvantageState = 'advantage_plus_sales' | 'advantage_plus_app';
export type MutableAdvantageState = 'classic';
export type AdvantageState = LegacyAdvantageState | MutableAdvantageState;
