...
// IMAGE OPTIONS TYPES
// ============================================================================
export type GammaImageSource = 'aiGenerated' | 'pictographic' | 'unsplash' | 'giphy' | 'webAllImages' | 'webFreeToUse' | 'webFreeToUseCommercially' | 'placeholder' | 'noImages';
export type GammaImageModel = 'flux-1-quick' // Flux Fast 1.1 (2 credits)
...
// TEXT OPTIONS TYPES
// ============================================================================
export type GammaLanguageCode = 'en' | 'en-gb' | 'en-in' // English variants
