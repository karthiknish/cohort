 ...
 */
export function getOperationErrorMessage<T extends OperationCategory>(category: T, errorType: OperationErrorKey<T>): string {
 ...
 */
export function getContextualErrorMessage(action: string, errorType: 'failed' | 'notFound' | 'unauthorized' | 'network' | 'timeout' = 'failed'): string {
