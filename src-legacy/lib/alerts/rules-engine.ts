...
// =============================================================================
import type { AlertRule, AlertResult, AlertMetric, DailyMetricData, ThresholdCondition, AnomalyCondition, TrendCondition, ThresholdOperator, } from './types';
 ...
 */
export function evaluateThresholdRule(rule: AlertRule, current: DailyMetricData, formula?: {
    formula: string;
    inputs: string[];
}): AlertResult {
 ...
 */
export function evaluateAnomalyRule(rule: AlertRule, current: DailyMetricData, history: DailyMetricData[]): AlertResult {
 ...
 */
export function evaluateTrendRule(rule: AlertRule, history: DailyMetricData[]): AlertResult {
 ...
 */
export function evaluateRule(rule: AlertRule, current: DailyMetricData, history: DailyMetricData[], formula?: {
    formula: string;
    inputs: string[];
}): AlertResult {
