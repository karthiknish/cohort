...
export class CacheManager {
    ...
    constructor(private readonly backend: CacheBackend, opts: CacheManagerOptions = {}) {
...
export function workspaceCacheKey(workspaceId: string, ...parts: Array<string | number | null | undefined>): string {
    const safeParts = parts.flatMap((part) => part !== null && part !== undefined ? [encodeURIComponent(String(part))] : []);
