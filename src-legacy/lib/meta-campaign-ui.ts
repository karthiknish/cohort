...
export type MetaCampaignObjective = 'OUTCOME_SALES' | 'OUTCOME_LEADS' | 'OUTCOME_TRAFFIC' | 'OUTCOME_ENGAGEMENT' | 'OUTCOME_AWARENESS' | 'OUTCOME_APP_PROMOTION' | null;
...
export function resolveMetaCampaignUiVisibility(context: MetaCampaignUiContext = {}): MetaCampaignUiVisibility {
...
export function hasMetaAdvancedTools(visibility: MetaCampaignUiVisibility): boolean {
    return (visibility.showPixelInsights
...
export function getMetaCreativeObjectTypeOptions(campaignObjective?: string | null, salesOptimizationMode?: 'pixel' | 'catalog'): MetaCreativeObjectTypeOption[] {
