...
import { getPreviewCollaborationAutoReply, getPreviewCollaborationMessages, getPreviewCollaborationParticipants, getPreviewCollaborationThreadReplies, getPreviewDirectConversations, getPreviewDirectAutoReply, getPreviewDirectMessages, } from './collaboration';
...
describe('interactive preview helpers', () => {
    ...
    it('keeps preview datasets broad and cross-linked for realistic demos', () => {
        ...
        expect(notifications.every((notification) => (notification.resource.type !== 'proposal' || proposalIds.has(notification.resource.id)))).toBe(true);
    });
