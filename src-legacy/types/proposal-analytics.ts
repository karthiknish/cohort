 ...
 */
export type ProposalEventType = 'draft_created' | 'draft_updated' | 'ai_generation_started' | 'ai_generation_completed' | 'ai_generation_failed' | 'deck_generation_started' | 'deck_generation_completed' | 'deck_generation_failed' | 'proposal_submitted' | 'proposal_sent' | 'proposal_viewed' | 'proposal_downloaded';
