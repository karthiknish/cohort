...
import type { AgentExecutionStep, AgentMessageLifecycle, AgentMessageMetadata, AgentPendingConfirmation, } from '@/lib/agent-message-lifecycle';
export type { AgentExecutionStep, AgentMessageLifecycle, AgentMessageMetadata, AgentPendingConfirmation, } from '@/lib/agent-message-lifecycle';
...
export interface UseAgentModeReturn {
    ...
    processInput: (text: string, options?: {
    ...
    confirmPendingAction: (pending: AgentPendingConfirmation, decision: 'confirm' | 'cancel' | 'edit') => void;
    ...
    exportConversation: (conversationId: string, format?: 'json' | 'markdown') => Promise<{
        content: string;
        title: string;
    } | null>;
    /** Copy share payload (markdown + deep link) for a conversation */
    shareConversation: (conversationId: string) => Promise<{
        markdown: string;
        deepLink: string;
    } | null>;
    // Error handling
