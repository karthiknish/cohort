...
describe('buildAgentDataSections', () => {
    it('builds chart series for analytics snapshots', () => {
        ...
        expect(charts.map((chart) => chart.id)).toEqual(expect.arrayContaining(['analytics-traffic', 'analytics-period-delta']));
    });
    it('builds chart series for social snapshots', () => {
        ...
        expect(charts.map((chart) => chart.id)).toEqual(expect.arrayContaining([
            'social-facebook',
            'social-instagram',
            'social-top-facebook',
    ...
    it('builds chart series for ads snapshots', () => {
        ...
        expect(charts.map((chart) => chart.id)).toEqual(expect.arrayContaining(['financial', 'delivery', 'period-delta', 'providers', 'top-campaigns']));
    });
    ...
    it('shows task summary sections for client task summaries', () => {
        ...
        expect(taskSummary?.items).toEqual(expect.arrayContaining([
