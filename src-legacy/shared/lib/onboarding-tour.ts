...
export function waitForTourTargets(selectors: string[], { timeoutMs = 2400, intervalMs = 80 }: {
    timeoutMs?: number;
    intervalMs?: number;
} = {}): Promise<void> {
