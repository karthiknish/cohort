...
export default function ForYouPage() {
    ...
    const rawTasks = useQuery(tasksApi.listForUser, canQueryConvex ? { workspaceId: workspaceId ?? '', userId: user?.id ?? '' } : 'skip');
    const liveNotifications = useQuery(notificationsApi.list, canQueryConvex && !isPreviewMode
