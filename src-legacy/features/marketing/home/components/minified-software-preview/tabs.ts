import { BarChart3, Bot, CalendarClock, FileText, LayoutDashboard, MessageSquare, Settings, Users, type LucideIcon, } from 'lucide-react';
...
export const SIDEBAR_EXTRA: readonly {
    id: string;
    Icon: LucideIcon;
}[] = [
