...
export function SocialsHeader({ selectedClientName, dateRange, onDateRangeChange, metricsReady = false, }: SocialsHeaderProps) {
    return (<FadeIn>
      <DashboardPageHero>
        <div className="relative space-y-3">
          <div className="flex flex-wrap items-start gap-4">
            ...
            <div className="min-w-0 flex-1 space-y-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {metricsReady ? (<Badge className={cn(getBadgeClasses('success'), 'gap-1 normal-case tracking-normal')}>
          ...
          {selectedClientName ? (<Badge className={getBadgeClasses('primary')}>Workspace · {selectedClientName}</Badge>) : null}
        </div>
