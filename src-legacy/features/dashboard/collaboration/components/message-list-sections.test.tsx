...
import { ChannelMessageCard, DirectMessageCard, MessageDateSeparator, MessageListEmptyState, MessageListLoadMoreButton, MessageListLoadingState, } from './message-list-sections';
...
const renderers = {
    ...
    renderMessageContent: function TestMessageContent({ message: msg }: {
...
describe('message list sections', () => {
    ...
    it('renders channel and dm message cards', () => {
        const markup = renderToStaticMarkup(<>
        <ChannelMessageCard currentUserId="user-1" highlighted={true} pending={idleChannelPending} localReactionPending={null} message={message} onReact={onReact} reactionPendingByMessage={emptyReactionPendingByMessage} renderers={renderers} showAvatars={true}/>
        <DirectMessageCard currentUserId="user-1" isDeleting={false} isEditing={false} localReactionPending={null} message={message} onReact={onReact} reactionPendingByMessage={emptyReactionPendingByMessage} renderers={renderers} showAvatars={true}/>
      </>);
