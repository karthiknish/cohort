...
describe('cross-channel-search composition', () => {
    it('renders the default dialog trigger', () => {
        const markup = renderToStaticMarkup(<CrossChannelSearch onSearch={handleSearch}/>);
        expect(markup).toContain('Search');
    });
    it('renders the inline quick search input placeholder', () => {
        const markup = renderToStaticMarkup(<QuickSearchInput onSearch={handleQuickSearch} placeholder="Find collaboration messages"/>);
