...
import { useUnifiedMessagePaneMessageSearch, type UseUnifiedMessagePaneSearchParams, } from './unified-message-pane-layout-hooks';
...
export function UnifiedMessagePaneMessageSearchBindings({ children, ...searchParams }: UseUnifiedMessagePaneSearchParams & {
