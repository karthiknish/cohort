...
export function DashboardEmptyPerformanceCard() {
    return (<Card className="overflow-hidden border-dashed border-muted/50 bg-linear-to-br from-muted/10 via-background to-primary/[0.03] shadow-sm">
...
export function DashboardSectionHeading({ eyebrow = 'Overview', title, description, className, }: DashboardSectionHeadingProps) {
    return (<div className={cn('space-y-1 border-b border-muted/40 pb-3', className)}>
