...
describe('upcoming meetings card sections', () => {
    ...
    it('renders an upcoming meeting item with actions and notes', () => {
        const markup = renderToStaticMarkup(<UpcomingMeetingItemCard meeting={meeting} canSchedule={true} cancellingMeetingId={null} onOpenInSiteMeeting={vi.fn()} onRescheduleMeeting={vi.fn()} onCancelMeeting={vi.fn()} onMarkCompleted={vi.fn()}/>);
