...
export function MeetingCancelDialog(props: MeetingCancelDialogProps) {
    ...
    return (<AlertDialog open={Boolean(meeting)} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={onConfirm} disabled={Boolean(cancellingMeetingId)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
