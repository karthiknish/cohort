...
function ProposalDeleteDialogComponent({ open, isDeleting, proposalName, onOpenChange, onConfirm }: ProposalDeleteDialogProps) {
    return (<Dialog open={open} onOpenChange={onOpenChange}>
      <ProposalDeleteDialogContent isDeleting={isDeleting} onConfirm={onConfirm} onOpenChange={onOpenChange} proposalName={proposalName}/>
    </Dialog>);
}
export const ProposalDeleteDialog = ProposalDeleteDialogComponent;
