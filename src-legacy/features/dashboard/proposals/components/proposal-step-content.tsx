...
import { ProposalCompanyStepSection, ProposalGoalsStepSection, ProposalMarketingStepSection, ProposalScopeStepSection, ProposalTimelinesStepSection, ProposalValueStepSection, } from './proposal-step-content-sections';
import type { ProposalStepContentProps } from './proposal-step-types';
export type { ProposalStepId } from './proposal-step-types';
function ProposalStepContentComponent({ stepId, formState, summary, validationErrors, onUpdateField, onToggleArrayValue, onChangeSocialHandle, }: ProposalStepContentProps) {
    switch (stepId) {
        case 'company':
...
export const ProposalStepContent = ProposalStepContentComponent;
