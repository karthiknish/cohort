...
import { ProposalStepIndicatorProgressBar, ProposalStepIndicatorRail, ProposalStepIndicatorSummary, } from './proposal-step-indicator-sections';
...
function ProposalStepIndicatorComponent({ steps, currentStep, submitted, }: ProposalStepIndicatorProps) {
    ...
    return (<div className="space-y-4">
      ...
      <ProposalStepIndicatorSummary activeStepTitle={activeStep?.title ?? 'Proposal step'} currentStep={currentStep} percentage={percentage} totalSteps={steps.length}/>
      <ProposalStepIndicatorProgressBar percentage={percentage}/>
    </div>);
}
export const ProposalStepIndicator = ProposalStepIndicatorComponent;
