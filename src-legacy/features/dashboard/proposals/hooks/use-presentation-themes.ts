...
import { FALLBACK_PRESENTATION_THEMES, type PresentationThemeOption, } from '@/lib/presentation-themes';
type ThemeRow = {
    id: string;
    name: string;
    type?: string;
...
function presentationThemesReducer(state: PresentationThemesState, action: PresentationThemesAction): PresentationThemesState {
    switch (action.type) {
        case 'beginLoad':
