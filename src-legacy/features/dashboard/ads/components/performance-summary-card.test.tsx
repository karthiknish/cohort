...
describe('performance summary card', () => {
    it('renders the empty state copy', () => {
        const markup = renderToStaticMarkup(<PerformanceSummaryCard providerSummaries={emptyProviderSummaries} hasMetrics={false} initialMetricsLoading={false} metricsLoading={false} metricError={null} onRefresh={vi.fn()} onExport={vi.fn()}/>);
    ...
    it('renders provider summary metrics', () => {
        const markup = renderToStaticMarkup(<PerformanceSummaryCard providerSummaries={metaAdsProviderSummary} currency="GBP" hasMetrics={true} initialMetricsLoading={false} metricsLoading={false} metricError={null} onRefresh={vi.fn()} onExport={vi.fn()}/>);
