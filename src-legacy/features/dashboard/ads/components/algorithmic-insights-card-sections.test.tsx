...
import { AlgorithmicInsightsCompactCard, AlgorithmicInsightsEmptyCard, AlgorithmicInsightsFullCard, AlgorithmicInsightsLoadingCard, } from './algorithmic-insights-card-sections';
const insight = {
...
describe('algorithmic insights card sections', () => {
    ...
    it('renders the compact variant', () => {
        ...
        const markup = renderToStaticMarkup(<AlgorithmicInsightsCompactCard criticalCount={0} displayedInsights={[insight]} globalEfficiencyScore={74} hasMoreInsights={true} insightsCount={3} onViewAll={onViewAll} title="AI-Powered Insights" warningCount={1}/>);
    ...
    it('renders the full variant', () => {
        const onViewAll = vi.fn();
        const markup = renderToStaticMarkup(<AlgorithmicInsightsFullCard criticalCount={1} description="Algorithmic analysis of ad performance" displayedInsights={[]} globalEfficiencyScore={38} hasMoreInsights={true} onViewAll={onViewAll} providerEfficiencyScores={providerEfficiencyScores} title="AI-Powered Insights"/>);
