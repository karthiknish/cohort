...
// MAIN COMPONENT
// =============================================================================
export function AlgorithmicInsightsCard({ insights, globalEfficiencyScore, providerEfficiencyScores, loading = false, compact = false, maxInsights = 5, onViewAll, title = 'AI-Powered Insights', description = 'Algorithmic analysis of your cross-platform ad performance', emptyMessage = 'Connect ad platforms and sync data to receive AI-powered insights.', }: AlgorithmicInsightsCardProps) {
