...
export type AudienceControlSectionAction = {
    ...
    value: MetaPlacementDetailDraft | null;
} | {
...
export function audienceControlSectionReducer(state: AudienceControlSectionState, action: AudienceControlSectionAction): AudienceControlSectionState {
    switch (action.type) {
        case 'setTargeting':
